...
class PackageBuilder
{
  ...
  public PackageBuilder(AdjustConfig paramAdjustConfig, DeviceInfo paramDeviceInfo, ActivityState paramActivityState, long paramLong)
  {
    ...
    this.activityState = paramActivityState.shallowCopy();
  ...
  private String getEventSuffix(AdjustEvent paramAdjustEvent)
  {
    ...
    for (paramAdjustEvent = String.format(Locale.US, " '%s'", new Object[] { paramAdjustEvent.eventToken });; paramAdjustEvent = String.format(Locale.US, " (%.4f %s, '%s')", new Object[] { paramAdjustEvent.revenue, paramAdjustEvent.currency, paramAdjustEvent.eventToken })) {
      return paramAdjustEvent;
    }
  }
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\adjust\sdk\PackageBuilder.class

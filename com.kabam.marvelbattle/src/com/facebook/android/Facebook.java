...
public class Facebook
{
  ...
  private void authorize(Activity paramActivity, String[] paramArrayOfString, int paramInt, SessionLoginBehavior paramSessionLoginBehavior, final DialogListener paramDialogListener)
  {
    ...
    for (;;)
    {
      ...
      paramArrayOfString = new Session.StatusCallback()
      {
  ...
  private void onSessionCallback(Session paramSession, SessionState paramSessionState, Exception arg3, DialogListener paramDialogListener)
  {
    ...
    for (;;)
    {
      ...
      if (??? != null) {
        ...
        } else if (((??? instanceof FacebookAuthorizationException)) && (localBundle != null) && (localBundle.containsKey("com.facebook.sdk.WebViewErrorCode")) && (localBundle.containsKey("com.facebook.sdk.FailingUrl"))) {
  ...
  {
    if (paramArrayOfString != null) {}
    for (paramArrayOfString = Arrays.asList(paramArrayOfString);; paramArrayOfString = Collections.emptyList()) {
  ...
  private boolean validateServiceIntent(Context paramContext, Intent paramIntent)
  {
    ...
    {
      return bool;
      bool = validateAppSignatureForPackage(paramContext, paramIntent.serviceInfo.packageName);
    }
  }
  ...
  public boolean extendAccessToken(Context paramContext, ServiceListener paramServiceListener)
  {
    ...
    for (boolean bool = false;; bool = paramContext.bindService(localIntent, new TokenRefreshServiceConnection(paramContext, paramServiceListener), 1)) {
      return bool;
    }
  }
  ...
  public String getAccessToken()
  {
    ...
    if (localObject != null) {}
    for (localObject = ((Session)localObject).getAccessToken();; localObject = null) {
  ...
  public final Session getSession()
  {
    for (;;)
    {
      ...
      if (localObject2 != null) {
        localObject2 = ((Session)localObject2).getPermissions();
      }
      for (;;)
      {
        ...
        if (this.pendingAuthorizationPermissions != null) {
          localObject2 = Arrays.asList(this.pendingAuthorizationPermissions);
        } else {
          localObject2 = Collections.emptyList();
        }
      }
      label155:
      ??? = new Session.OpenRequest(this.pendingAuthorizationActivity).setPermissions((List)localObject2);
      boolean bool;
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\facebook\android\Facebook.class

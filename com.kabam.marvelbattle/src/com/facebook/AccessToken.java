  ...
  implements Serializable
{
  ...
  private static AccessToken createFromBundle(List<String> paramList, Bundle paramBundle, AccessTokenSource paramAccessTokenSource, Date paramDate)
  {
    ...
    for (paramList = null;; paramList = new AccessToken(str, paramBundle, paramList, null, paramAccessTokenSource, new Date())) {
      return paramList;
    }
  }
  ...
  {
    List localList2 = getPermissionsFromBundle(paramBundle, "com.facebook.TokenCachingStrategy.Permissions");
    List localList1 = getPermissionsFromBundle(paramBundle, "com.facebook.TokenCachingStrategy.DeclinedPermissions");
    return new AccessToken(paramBundle.getString("com.facebook.TokenCachingStrategy.Token"), TokenCachingStrategy.getDate(paramBundle, "com.facebook.TokenCachingStrategy.ExpirationDate"), localList2, localList1, TokenCachingStrategy.getSource(paramBundle), TokenCachingStrategy.getDate(paramBundle, "com.facebook.TokenCachingStrategy.LastRefreshDate"));
  }
  ...
  public static AccessToken createFromExistingAccessToken(String paramString, Date paramDate1, Date paramDate2, AccessTokenSource paramAccessTokenSource, List<String> paramList)
  {
    ...
    return new AccessToken(paramString, localDate, paramList, null, paramDate2, paramDate1);
  }
  ...
  public static AccessToken createFromNativeLinkingIntent(Intent paramIntent)
  {
    ...
    for (paramIntent = (Intent)localObject;; paramIntent = createFromBundle(null, paramIntent.getExtras(), AccessTokenSource.FACEBOOK_APPLICATION_WEB, new Date())) {
      return paramIntent;
    }
  }
  ...
  private static AccessToken createNew(List<String> paramList1, List<String> paramList2, String paramString, Date paramDate, AccessTokenSource paramAccessTokenSource)
  {
    ...
    for (paramList1 = createEmptyToken();; paramList1 = new AccessToken(paramString, paramDate, paramList1, paramList2, paramAccessTokenSource, new Date())) {
      return paramList1;
    }
  }
  ...
  private static Date getBundleLongAsDate(Bundle paramBundle, String paramString, Date paramDate)
  {
    ...
    for (;;)
    {
      ...
      continue;
      label81:
      paramBundle = new Date(paramDate.getTime() + 1000L * l);
    }
  }
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\facebook\AccessToken.class

  ...
  extends ContentProvider
{
  ...
  Pair<UUID, String> parseCallIdAndAttachmentName(Uri paramUri)
  {
    try
    {
      ...
      UUID localUUID = UUID.fromString(paramUri);
      paramUri = new android/util/Pair;
      paramUri.<init>(localUUID, localObject);
    }
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\facebook\NativeAppCallContentProvider.class

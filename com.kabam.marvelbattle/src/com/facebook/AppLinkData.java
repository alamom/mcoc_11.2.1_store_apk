...
public class AppLinkData
{
  ...
  private static AppLinkData createFromJson(String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          paramString = new com/facebook/AppLinkData;
          paramString.<init>();
          paramString.arguments = localJSONObject.getJSONObject("method_args");
          if (!paramString.arguments.has("ref")) {
            break label153;
          }
          paramString.ref = paramString.arguments.getString("ref");
          if (paramString.arguments.has("target_url")) {
            paramString.targetUri = Uri.parse(paramString.arguments.getString("target_url"));
          }
          paramString.argumentBundle = toBundle(paramString.arguments);
        }
      }
      catch (JSONException paramString)
      {
        for (;;)
        {
          ...
          paramString = null;
          break;
          if (paramString.arguments.has("referer_data"))
          {
            localJSONObject = paramString.arguments.getJSONObject("referer_data");
            if (localJSONObject.has("fb_ref")) {
              paramString.ref = localJSONObject.getString("fb_ref");
            }
          }
        }
      }
  ...
  private static AppLinkData createFromUri(Uri paramUri)
  {
    ...
    for (paramUri = null;; paramUri = localAppLinkData)
    {
      return paramUri;
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\facebook\AppLinkData.class

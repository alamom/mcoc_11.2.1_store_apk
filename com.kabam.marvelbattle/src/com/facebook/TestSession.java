  ...
  extends Session
{
  ...
  private static TestSession createTestSession(Activity paramActivity, List<String> paramList, Mode paramMode, String paramString)
  {
    try
    {
      if ((Utility.isNullOrEmpty(testApplicationId)) || (Utility.isNullOrEmpty(testApplicationSecret)))
      {
        ...
        paramActivity.<init>("Must provide app ID and secret");
        throw paramActivity;
      }
    }
    finally {}
    ...
    paramList = new com/facebook/TestSession$TestTokenCachingStrategy;
    paramList.<init>(null);
    paramActivity = new TestSession(paramActivity, (List)localObject, paramList, paramString, paramMode);
  ...
  private void deleteTestAccount(String paramString1, String paramString2)
  {
    ...
    {
      return;
      if ((((GraphObject)localObject).getProperty("FACEBOOK_NON_JSON_RESULT") == Boolean.valueOf(false)) || (((GraphObject)localObject).getProperty("success") == Boolean.valueOf(false))) {
  ...
  private static void retrieveTestAccountsForAppIfNeeded()
  {
    for (;;)
    {
      try
      {
        ...
        appTestAccounts = (Map)localObject1;
        Request.setDefaultBatchApplicationId(testApplicationId);
        Object localObject3 = new android/os/Bundle;
        ((Bundle)localObject3).<init>();
        ((Bundle)localObject3).putString("access_token", getAppAccessToken());
        localObject1 = new com/facebook/Request;
        ((Request)localObject1).<init>(null, "app/accounts/test-users", (Bundle)localObject3, null);
        ((Request)localObject1).setBatchEntryName("testUsers");
        ((Request)localObject1).setBatchEntryOmitResultOnSuccess(false);
        Bundle localBundle = new android/os/Bundle;
        localBundle.<init>();
        localBundle.putString("access_token", getAppAccessToken());
        localBundle.putString("ids", "{result=testUsers:$.data.*.id}");
        localBundle.putString("fields", "name");
        localObject3 = new com/facebook/Request;
        ((Request)localObject3).<init>(null, "", localBundle, null);
        ...
        if ((localObject1 == null) || (((List)localObject1).size() != 2))
        {
          ...
          ((FacebookException)localObject1).<init>("Unexpected number of results from TestUsers batch query");
  ...
  public static void setTestApplicationId(String paramString)
  {
    try
    {
      ...
      {
        paramString = new com/facebook/FacebookException;
        paramString.<init>("Can't have more than one test application ID");
        throw paramString;
      }
    }
    finally {}
  ...
  public static void setTestApplicationSecret(String paramString)
  {
    try
    {
      ...
      {
        paramString = new com/facebook/FacebookException;
        paramString.<init>("Can't have more than one test application secret");
        throw paramString;
      }
    }
    finally {}
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\facebook\TestSession.class

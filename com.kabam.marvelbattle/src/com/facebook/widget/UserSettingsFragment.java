  ...
  extends FacebookFragment
{
  ...
  private ImageRequest getImageRequest()
  {
    ...
    try
    {
      ...
      ((ImageRequest.Builder)localObject2).<init>(getActivity(), ImageRequest.getProfilePictureUrl(this.user.getId(), getResources().getDimensionPixelSize(R.dimen.com_facebook_usersettingsfragment_profile_picture_width), getResources().getDimensionPixelSize(R.dimen.com_facebook_usersettingsfragment_profile_picture_height)));
      localObject2 = ((ImageRequest.Builder)localObject2).setCallerTag(this);
      ImageRequest.Callback local2 = new com/facebook/widget/UserSettingsFragment$2;
      local2.<init>(this);
      localObject2 = ((ImageRequest.Builder)localObject2).setCallback(local2).build();
    ...
    return (ImageRequest)localObject1;
  }
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\facebook\widget\UserSettingsFragment.class

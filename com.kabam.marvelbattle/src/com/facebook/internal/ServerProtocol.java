...
public final class ServerProtocol
{
  ...
  public static Bundle getQueryParamsForPlatformActivityIntentWebFallback(Context paramContext, String paramString1, int paramInt, String paramString2, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      {
        paramContext = null;
        Logger.log(LoggingBehavior.DEVELOPER_ERRORS, 6, TAG, "Error creating Url -- " + paramString1);
      }
    }
  }
}
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\facebook\internal\ServerProtocol.class

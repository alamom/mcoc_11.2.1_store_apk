...
public class UiLifecycleHelper
{
  ...
  private boolean handleFacebookDialogActivityResult(int paramInt1, int paramInt2, Intent paramIntent, FacebookDialog.Callback paramCallback)
  {
    ...
    for (;;)
    {
      ...
      {
        bool1 = bool2;
        if (localPendingCall.getRequestCode() == paramInt1)
        {
          if (paramIntent != null) {
            break;
          }
  ...
  public AppEventsLogger getAppEventsLogger()
  {
    ...
    if (localObject == null) {}
    for (localObject = null;; localObject = this.appEventsLogger)
    {
      return (AppEventsLogger)localObject;
      if ((this.appEventsLogger == null) || (!this.appEventsLogger.isValidForSession((Session)localObject)))
      {
        if (this.appEventsLogger != null) {
          AppEventsLogger.onContextStop();
        }
        this.appEventsLogger = AppEventsLogger.newLogger(this.activity, (Session)localObject);
      }
    }
  }
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\facebook\UiLifecycleHelper.class

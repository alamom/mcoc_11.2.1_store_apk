  ...
  implements b
{
  ...
  public void connect()
  {
    ...
    for (;;)
    {
      return;
      this.xG = new a();
      boolean bool = this.mContext.bindService(localIntent, this.xG, 129);
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\analytics\c.class

...
public class HitBuilders
{
  ...
  protected static class HitBuilder<T extends HitBuilder>
  {
    ...
    public Map<String, String> build()
    {
      ...
      Object localObject1 = this.AL.iterator();
      for (int i = 1; ((Iterator)localObject1).hasNext(); i++) {
        localHashMap.putAll(((Promotion)((Iterator)localObject1).next()).aq(n.A(i)));
      }
      localObject1 = this.AM.iterator();
      for (i = 1; ((Iterator)localObject1).hasNext(); i++) {
        localHashMap.putAll(((Product)((Iterator)localObject1).next()).aq(n.z(i)));
      }
      Iterator localIterator = this.AK.entrySet().iterator();
      for (i = 1; localIterator.hasNext(); i++)
      {
        ...
        for (int j = 1; ((Iterator)localObject2).hasNext(); j++) {
          localHashMap.putAll(((Product)((Iterator)localObject2).next()).aq((String)localObject1 + n.B(j)));
        }
        if (!TextUtils.isEmpty((CharSequence)localEntry.getKey())) {
          localHashMap.put((String)localObject1 + "nm", localEntry.getKey());
        }
      }
      return localHashMap;
    }
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\analytics\HitBuilders.class

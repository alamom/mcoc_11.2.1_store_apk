  ...
  public boolean equals(Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        if ((!n.equal(this.acH, ((Asset)paramObject).acH)) || (!n.equal(this.auQ, ((Asset)paramObject).auQ)) || (!n.equal(this.auR, ((Asset)paramObject).auR)) || (!n.equal(this.uri, ((Asset)paramObject).uri))) {
          bool = false;
        }
      }
    }
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\wearable\Asset.class

  ...
  implements SafeParcelable
{
  ...
  {
    if ((n.equal(this.Sq, paramFitnessSensorServiceRequest.Sq)) && (this.Vc == paramFitnessSensorServiceRequest.Vc) && (this.Vd == paramFitnessSensorServiceRequest.Vd)) {}
  ...
  {
    if ((this == paramObject) || (((paramObject instanceof FitnessSensorServiceRequest)) && (a((FitnessSensorServiceRequest)paramObject)))) {}
    for (boolean bool = true;; bool = false) {
      return bool;
    }
  }
  ...
  public long getSamplingRate(TimeUnit paramTimeUnit)
  {
    ...
    {
      return l;
      l = paramTimeUnit.convert(this.Vc, TimeUnit.MICROSECONDS);
    }
  }
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\fitness\service\FitnessSensorServiceRequest.class

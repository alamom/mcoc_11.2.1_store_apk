...
public class FitnessActivities
{
  ...
  {
    int i = 4;
    int j = So.indexOfValue(paramString);
    if (j < 0) {}
    for (;;)
    {
      return i;
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\fitness\FitnessActivities.class

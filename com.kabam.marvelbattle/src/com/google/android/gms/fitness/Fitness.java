...
public class Fitness
{
  ...
  {
    long l1 = -1L;
    long l2 = paramIntent.getLongExtra("vnd.google.fitness.end_time", -1L);
    if (l2 == -1L) {}
    for (;;)
    {
      return l1;
  ...
  {
    long l1 = -1L;
    long l2 = paramIntent.getLongExtra("vnd.google.fitness.start_time", -1L);
    if (l2 == -1L) {}
    for (;;)
    {
      return l1;
  ...
  private static BleApi iy()
  {
    ...
    for (Object localObject = new kx();; localObject = new le()) {
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\fitness\Fitness.class

...
public abstract interface SessionsApi
{
  ...
  public static class ViewIntentBuilder
  {
    ...
    private Intent i(Intent paramIntent)
    {
      ...
      {
        return paramIntent;
        Intent localIntent = new Intent(paramIntent).setPackage(this.Ss);
        ResolveInfo localResolveInfo = this.mContext.getPackageManager().resolveActivity(localIntent, 0);
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\fitness\SessionsApi.class

  ...
  implements Result, SafeParcelable
{
  ...
  {
    if ((this.CM.equals(paramDataSourcesResult.CM)) && (n.equal(this.Uk, paramDataSourcesResult.Uk))) {}
  ...
  {
    if ((this == paramObject) || (((paramObject instanceof DataSourcesResult)) && (b((DataSourcesResult)paramObject)))) {}
    for (boolean bool = true;; bool = false) {
      return bool;
    }
  }
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\fitness\result\DataSourcesResult.class

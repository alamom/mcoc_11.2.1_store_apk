  ...
  implements Result, SafeParcelable
{
  ...
  {
    if ((this.CM.equals(paramSessionReadResult.CM)) && (n.equal(this.Ul, paramSessionReadResult.Ul)) && (n.equal(this.UZ, paramSessionReadResult.UZ))) {}
  ...
  {
    if ((this == paramObject) || (((paramObject instanceof SessionReadResult)) && (b((SessionReadResult)paramObject)))) {}
    for (boolean bool = true;; bool = false) {
      return bool;
    }
  }
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\fitness\result\SessionReadResult.class

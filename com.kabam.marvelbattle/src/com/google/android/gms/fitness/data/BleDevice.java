  ...
  implements SafeParcelable
{
  ...
  {
    if ((this.mName.equals(paramBleDevice.mName)) && (this.Sz.equals(paramBleDevice.Sz)) && (ki.a(paramBleDevice.SA, this.SA)) && (ki.a(this.SB, paramBleDevice.SB))) {}
  ...
  {
    if ((paramObject == this) || (((paramObject instanceof BleDevice)) && (a((BleDevice)paramObject)))) {}
    for (boolean bool = true;; bool = false) {
      return bool;
    }
  }
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\fitness\data\BleDevice.class

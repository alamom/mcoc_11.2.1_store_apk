  ...
  implements SafeParcelable
{
  ...
  {
    if ((n.equal(this.Sq, paramSubscription.Sq)) && (n.equal(this.Sp, paramSubscription.Sp)) && (this.Tt == paramSubscription.Tt) && (this.Tu == paramSubscription.Tu)) {}
  ...
  {
    if ((this == paramObject) || (((paramObject instanceof Subscription)) && (a((Subscription)paramObject)))) {}
    for (boolean bool = true;; bool = false) {
      return bool;
    }
  }
  ...
  {
    if (this.Sp == null) {}
    for (DataType localDataType = this.Sq.getDataType();; localDataType = this.Sp) {
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\fitness\data\Subscription.class

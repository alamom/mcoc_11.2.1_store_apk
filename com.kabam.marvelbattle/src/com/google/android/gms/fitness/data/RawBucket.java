  ...
  implements SafeParcelable
{
  ...
  {
    if ((this.KS == paramRawBucket.KS) && (this.Sr == paramRawBucket.Sr) && (this.Tl == paramRawBucket.Tl) && (n.equal(this.SD, paramRawBucket.SD)) && (this.SE == paramRawBucket.SE) && (this.SF == paramRawBucket.SF)) {}
  ...
  {
    if ((this == paramObject) || (((paramObject instanceof RawBucket)) && (a((RawBucket)paramObject)))) {}
    for (boolean bool = true;; bool = false) {
      return bool;
    }
  }
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\fitness\data\RawBucket.class

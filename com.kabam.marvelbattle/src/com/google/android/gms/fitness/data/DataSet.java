  ...
  implements SafeParcelable
{
  ...
  DataSet(int paramInt, DataSource paramDataSource, DataType paramDataType, List<RawDataPoint> paramList, List<DataSource> paramList1, boolean paramBoolean)
  {
    ...
    {
      this.SN = paramList1;
      paramDataType = paramList.iterator();
      while (paramDataType.hasNext())
      {
        paramDataSource = (RawDataPoint)paramDataType.next();
        this.SM.add(new DataPoint(this.SN, paramDataSource));
      }
  ...
  {
    if ((n.equal(this.Sp, paramDataSet.Sp)) && (n.equal(this.Sq, paramDataSet.Sq)) && (n.equal(this.SM, paramDataSet.SM)) && (this.SF == paramDataSet.SF)) {}
  ...
  private static <T> T b(List<T> paramList, int paramInt)
  {
    ...
    for (paramList = paramList.get(paramInt);; paramList = null) {
      return paramList;
    }
  }
  ...
  {
    if ((paramObject == this) || (((paramObject instanceof DataSet)) && (a((DataSet)paramObject)))) {}
    for (boolean bool = true;; bool = false) {
      return bool;
    }
  }
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\fitness\data\DataSet.class

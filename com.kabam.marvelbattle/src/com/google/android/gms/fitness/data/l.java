  ...
  public static class a
  {
    ...
    public l a(OnDataPointListener paramOnDataPointListener)
    {
      synchronized (this.Tk)
      {
        ...
        if (locall2 == null)
        {
          locall1 = new com/google/android/gms/fitness/data/l;
          locall1.<init>(paramOnDataPointListener, null);
    ...
    public l c(OnDataPointListener paramOnDataPointListener)
    {
      synchronized (this.Tk)
      {
        ...
        if (locall != null)
        {
          paramOnDataPointListener = locall;
          return paramOnDataPointListener;
        }
        locall = new com/google/android/gms/fitness/data/l;
        locall.<init>(paramOnDataPointListener, null);
        paramOnDataPointListener = locall;
      }
    }
  }
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\fitness\data\l.class

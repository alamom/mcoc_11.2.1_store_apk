  ...
  implements SafeParcelable
{
  ...
  {
    if ((this.SG == paramRawDataPoint.SG) && (this.SH == paramRawDataPoint.SH) && (Arrays.equals(this.SI, paramRawDataPoint.SI)) && (this.Tm == paramRawDataPoint.Tm) && (this.Tn == paramRawDataPoint.Tn) && (this.SK == paramRawDataPoint.SK)) {}
  ...
  {
    if ((this == paramObject) || (((paramObject instanceof RawDataPoint)) && (a((RawDataPoint)paramObject)))) {}
    for (boolean bool = true;; bool = false) {
      return bool;
    }
  }
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\fitness\data\RawDataPoint.class

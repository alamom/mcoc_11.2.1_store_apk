  ...
  implements SafeParcelable
{
  ...
  {
    if ((paramContext.getResources().getConfiguration().uiMode & 0xF) == 6) {}
  ...
  private static int Q(Context paramContext)
  {
    try
    {
      i = paramContext.getPackageManager().getPackageInfo("com.google.android.gms", 0).versionCode;
      return i;
    }
  ...
  {
    if ((n.equal(this.SZ, paramDevice.SZ)) && (n.equal(this.Ta, paramDevice.Ta)) && (n.equal(this.Sx, paramDevice.Sx)) && (n.equal(this.Tb, paramDevice.Tb)) && (this.FD == paramDevice.FD) && (this.Tc == paramDevice.Tc)) {}
    for (boolean bool = true;; bool = false) {
      return bool;
    }
  }
  ...
  {
    if ((this == paramObject) || (((paramObject instanceof Device)) && (a((Device)paramObject)))) {}
    for (boolean bool = true;; bool = false) {
      return bool;
    }
  }
  ...
  {
    if ((kw.jc()) || (iS())) {}
    for (String str = this.Tb;; str = kw.bt(this.Tb)) {
      return str;
    }
  }
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\fitness\data\Device.class

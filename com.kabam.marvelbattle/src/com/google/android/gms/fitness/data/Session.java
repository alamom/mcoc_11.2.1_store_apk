  ...
  implements SafeParcelable
{
  ...
  {
    if ((this.KS == paramSession.KS) && (this.Sr == paramSession.Sr) && (n.equal(this.mName, paramSession.mName)) && (n.equal(this.Tq, paramSession.Tq)) && (n.equal(this.Tr, paramSession.Tr)) && (n.equal(this.SP, paramSession.SP)) && (this.SC == paramSession.SC)) {}
  ...
  {
    if (paramIntent == null) {}
    for (paramIntent = null;; paramIntent = (Session)c.a(paramIntent, "vnd.google.fitness.session", CREATOR)) {
      return paramIntent;
    }
  }
  ...
  {
    if ((paramObject == this) || (((paramObject instanceof Session)) && (a((Session)paramObject)))) {}
    for (boolean bool = true;; bool = false) {
      return bool;
    }
  }
  ...
  {
    if (this.SP == null) {}
    for (String str = null;; str = this.SP.getPackageName()) {
      return str;
    }
  }
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\fitness\data\Session.class

  ...
  implements SafeParcelable
{
  ...
  {
    if ((this.mName.equals(paramDataType.mName)) && (this.SY.equals(paramDataType.SY))) {}
  ...
  public static List<DataType> getAggregatesForInput(DataType paramDataType)
  {
    ...
    for (paramDataType = Collections.emptyList();; paramDataType = Collections.unmodifiableList(paramDataType)) {
  ...
  {
    if ((this == paramObject) || (((paramObject instanceof DataType)) && (a((DataType)paramObject)))) {}
    for (boolean bool = true;; bool = false) {
      return bool;
    }
  }
  ...
  public String iQ()
  {
    ...
    for (String str = this.mName.substring(11);; str = this.mName) {
      return str;
    }
  }
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\fitness\data\DataType.class

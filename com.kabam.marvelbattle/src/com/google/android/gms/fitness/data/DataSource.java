  ...
  implements SafeParcelable
{
  ...
  {
    if (paramIntent == null) {}
    for (paramIntent = null;; paramIntent = (DataSource)c.a(paramIntent, "vnd.google.fitness.data_source", CREATOR)) {
      return paramIntent;
    }
  }
  ...
  private String getTypeString()
  {
    ...
    for (String str = "raw";; str = "derived") {
      return str;
    }
  }
  ...
  {
    if ((this == paramObject) || (((paramObject instanceof DataSource)) && (a((DataSource)paramObject)))) {}
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\fitness\data\DataSource.class

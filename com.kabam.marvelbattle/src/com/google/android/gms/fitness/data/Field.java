  ...
  implements SafeParcelable
{
  ...
  {
    if ((this.mName.equals(paramField.mName)) && (this.Th == paramField.Th)) {}
  ...
  {
    if ((this == paramObject) || (((paramObject instanceof Field)) && (a((Field)paramObject)))) {}
    for (boolean bool = true;; bool = false) {
      return bool;
    }
  }
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\fitness\data\Field.class

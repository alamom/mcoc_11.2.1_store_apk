  ...
  implements SafeParcelable
{
  ...
  {
    if ((this.SB.equals(paramDataReadRequest.SB)) && (this.Uk.equals(paramDataReadRequest.Uk)) && (this.KS == paramDataReadRequest.KS) && (this.Sr == paramDataReadRequest.Sr) && (this.SE == paramDataReadRequest.SE) && (this.Up.equals(paramDataReadRequest.Up)) && (this.Uo.equals(paramDataReadRequest.Uo)) && (n.equal(this.Ur, paramDataReadRequest.Ur)) && (this.Uq == paramDataReadRequest.Uq) && (this.Uv == paramDataReadRequest.Uv)) {}
  ...
  {
    if ((this == paramObject) || (((paramObject instanceof DataReadRequest)) && (a((DataReadRequest)paramObject)))) {}
    for (boolean bool = true;; bool = false) {
      return bool;
    }
  }
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\fitness\request\DataReadRequest.class

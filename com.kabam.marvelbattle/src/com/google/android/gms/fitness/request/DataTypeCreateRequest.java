  ...
  implements SafeParcelable
{
  ...
  {
    if ((n.equal(this.mName, paramDataTypeCreateRequest.mName)) && (n.equal(this.SY, paramDataTypeCreateRequest.SY))) {}
  ...
  {
    if ((paramObject == this) || (((paramObject instanceof DataTypeCreateRequest)) && (a((DataTypeCreateRequest)paramObject)))) {}
    for (boolean bool = true;; bool = false) {
      return bool;
    }
  }
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\fitness\request\DataTypeCreateRequest.class

...
public class SensorRequest
{
  ...
  private SensorRequest(DataSource paramDataSource, LocationRequest paramLocationRequest)
  {
    ...
    if (l == Long.MAX_VALUE) {}
    for (this.UJ = Long.MAX_VALUE;; this.UJ = TimeUnit.MILLISECONDS.toMicros(l - SystemClock.elapsedRealtime())) {
      return;
    }
  }
  ...
  {
    if ((n.equal(this.Sq, paramSensorRequest.Sq)) && (n.equal(this.Sp, paramSensorRequest.Sp)) && (this.Tt == paramSensorRequest.Tt) && (this.UE == paramSensorRequest.UE) && (this.UD == paramSensorRequest.UD) && (this.Tu == paramSensorRequest.Tu) && (n.equal(this.UI, paramSensorRequest.UI)) && (this.UJ == paramSensorRequest.UJ)) {}
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\fitness\request\SensorRequest.class

  ...
  implements SafeParcelable
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      } else if ((((DriveId)paramObject).Nj == -1L) && (this.Nj == -1L)) {
        bool = ((DriveId)paramObject).Ni.equals(this.Ni);
      } else if (((DriveId)paramObject).Nj == this.Nj) {
        bool = true;
      }
    }
  }
  ...
  {
    if (this.Nj == -1L) {}
    for (int i = this.Ni.hashCode();; i = (String.valueOf(this.Nk) + String.valueOf(this.Nj)).hashCode()) {
      return i;
    }
  }
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\drive\DriveId.class

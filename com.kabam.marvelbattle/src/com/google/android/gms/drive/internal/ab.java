    ...
    public static ab U(IBinder paramIBinder)
    {
      ...
      for (;;)
      {
        ...
        if ((localIInterface != null) && ((localIInterface instanceof ab))) {
          paramIBinder = (ab)localIInterface;
        } else {
        ...
        for (;;)
        {
          try
          {
            ...
            if (paramRealtimeDocumentSyncRequest != null)
            {
              ...
              paramRealtimeDocumentSyncRequest.writeToParcel(localParcel2, 0);
              if (paramac != null)
              {
                paramRealtimeDocumentSyncRequest = paramac.asBinder();
                localParcel2.writeStrongBinder(paramRealtimeDocumentSyncRequest);
                this.lb.transact(34, localParcel2, localParcel1, 0);
          ...
          try
          {
            ...
            if (paramAddEventListenerRequest != null)
            {
              ...
              if (paramad != null)
              {
                ...
                localParcel2.writeStrongBinder(paramAddEventListenerRequest);
          ...
          try
          {
            ...
            if (paramCloseContentsAndUpdateMetadataRequest != null)
            {
              ...
              if (paramac != null)
              {
                ...
                localParcel2.writeStrongBinder(paramCloseContentsAndUpdateMetadataRequest);
        ...
        throws RemoteException
      {
        ...
        for (;;)
        {
          try
          {
            ...
            {
              localParcel2.writeInt(1);
              paramCloseContentsRequest.writeToParcel(localParcel2, 0);
              if (paramac != null)
              {
                paramCloseContentsRequest = paramac.asBinder();
                localParcel2.writeStrongBinder(paramCloseContentsRequest);
        ...
        throws RemoteException
      {
        ...
        for (;;)
        {
          try
          {
            ...
            {
              localParcel2.writeInt(1);
              paramCreateFileRequest.writeToParcel(localParcel2, 0);
              if (paramac != null)
              {
                paramCreateFileRequest = paramac.asBinder();
                localParcel2.writeStrongBinder(paramCreateFileRequest);
          ...
          try
          {
            ...
            if (paramCreateFolderRequest != null)
            {
              ...
              if (paramac != null)
              {
                ...
                localParcel2.writeStrongBinder(paramCreateFolderRequest);
        ...
        throws RemoteException
      {
        ...
        for (;;)
        {
          try
          {
            ...
            {
              localParcel2.writeInt(1);
              paramGetDriveIdFromUniqueIdentifierRequest.writeToParcel(localParcel2, 0);
              if (paramac != null)
              {
                paramGetDriveIdFromUniqueIdentifierRequest = paramac.asBinder();
                localParcel2.writeStrongBinder(paramGetDriveIdFromUniqueIdentifierRequest);
                this.lb.transact(29, localParcel2, localParcel1, 0);
                localParcel1.readException();
              }
            }
            else
          ...
          try
          {
            ...
            if (paramGetMetadataRequest != null)
            {
              ...
              if (paramac != null)
              {
                ...
                localParcel2.writeStrongBinder(paramGetMetadataRequest);
          ...
          try
          {
            ...
            if (paramListParentsRequest != null)
            {
              ...
              if (paramac != null)
              {
                ...
                localParcel2.writeStrongBinder(paramListParentsRequest);
          ...
          try
          {
            ...
            if (paramLoadRealtimeRequest != null)
            {
              ...
              if (paramac != null)
              {
                ...
                localParcel2.writeStrongBinder(paramLoadRealtimeRequest);
                this.lb.transact(27, localParcel2, localParcel1, 0);
                localParcel1.readException();
              }
            }
            else
        ...
        throws RemoteException
      {
        ...
        for (;;)
        {
          try
          {
            ...
            {
              localParcel2.writeInt(1);
              paramSetDrivePreferencesRequest.writeToParcel(localParcel2, 0);
              if (paramac != null)
              {
                paramSetDrivePreferencesRequest = paramac.asBinder();
                localParcel2.writeStrongBinder(paramSetDrivePreferencesRequest);
                this.lb.transact(33, localParcel2, localParcel1, 0);
                localParcel1.readException();
              }
            }
            else
        ...
        throws RemoteException
      {
        ...
        for (;;)
        {
          try
          {
            ...
            {
              localParcel2.writeInt(1);
              paramSetResourceParentsRequest.writeToParcel(localParcel2, 0);
              if (paramac != null)
              {
                paramSetResourceParentsRequest = paramac.asBinder();
                localParcel2.writeStrongBinder(paramSetResourceParentsRequest);
                this.lb.transact(28, localParcel2, localParcel1, 0);
                localParcel1.readException();
              }
            }
            else
        ...
        throws RemoteException
      {
        ...
        for (;;)
        {
          try
          {
            ...
            {
              localParcel2.writeInt(1);
              paramQueryRequest.writeToParcel(localParcel2, 0);
              if (paramac != null)
              {
                paramQueryRequest = paramac.asBinder();
                localParcel2.writeStrongBinder(paramQueryRequest);
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\drive\internal\ab.class

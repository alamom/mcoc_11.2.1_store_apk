  ...
  public boolean equals(Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      if ((paramObject instanceof ah))
      {
        ...
        bool1 = bool2;
        if (this.versionCode == ((ah)paramObject).versionCode) {
          if (this.Pl == null)
          {
            bool1 = bool2;
            if (((ah)paramObject).Pl != null) {}
          }
          else
          {
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\drive\internal\ah.class

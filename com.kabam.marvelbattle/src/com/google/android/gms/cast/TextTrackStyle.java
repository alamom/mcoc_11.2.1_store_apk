...
public final class TextTrackStyle
{
  ...
  private int aC(String paramString)
  {
    ...
    try
    {
      ...
      i = Color.argb(Integer.parseInt(paramString.substring(7, 9), 16), i, k, m);
      return i;
    }
  ...
  public static TextTrackStyle fromSystemSettings(Context paramContext)
  {
    ...
    default: 
      ...
      if (paramContext != null)
      {
        ...
        bool2 = paramContext.isBold();
        bool1 = paramContext.isItalic();
        if ((!bool2) || (!bool1)) {
          break label203;
        }
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\cast\TextTrackStyle.class

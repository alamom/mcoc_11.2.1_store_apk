      ...
      protected void a(ij arg1)
      {
        synchronized (RemoteMediaPlayer.c(RemoteMediaPlayer.this))
        {
          ...
          catch (IllegalStateException localIllegalStateException)
          {
            for (;;)
            {
              Status localStatus1 = new com/google/android/gms/common/api/Status;
              localStatus1.<init>(2100);
              b(l(localStatus1));
              RemoteMediaPlayer.d(RemoteMediaPlayer.this).b(null);
            }
            localObject1 = finally;
          ...
          catch (IOException localIOException)
          {
            for (;;)
            {
              Status localStatus2 = new com/google/android/gms/common/api/Status;
              localStatus2.<init>(2100);
              b(l(localStatus2));
              RemoteMediaPlayer.d(RemoteMediaPlayer.this).b(null);
            }
          }
      ...
      protected void a(ij arg1)
      {
        synchronized (RemoteMediaPlayer.c(RemoteMediaPlayer.this))
        {
          ...
          catch (IOException localIOException)
          {
            for (;;)
            {
              Status localStatus3 = new com/google/android/gms/common/api/Status;
              localStatus3.<init>(2100);
              b(l(localStatus3));
              RemoteMediaPlayer.d(RemoteMediaPlayer.this).b(null);
            }
          }
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\cast\RemoteMediaPlayer.class

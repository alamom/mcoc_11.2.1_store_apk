    ...
    try
    {
      ...
      default: 
        ...
        if (this.Fj != null)
        {
          ...
          localJSONArray.<init>();
          localObject = this.Fj.iterator();
          while (((Iterator)localObject).hasNext())
          {
            localJSONArray.put(((MediaTrack)((Iterator)localObject).next()).bK());
            continue;
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\cast\MediaInfo.class

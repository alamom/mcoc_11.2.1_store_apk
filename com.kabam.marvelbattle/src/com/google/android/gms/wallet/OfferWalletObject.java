  ...
  implements SafeParcelable
{
  ...
  OfferWalletObject(int paramInt, String paramString1, String paramString2, CommonWalletObject paramCommonWalletObject)
  {
    ...
    if (paramInt < 3) {}
    for (this.atE = CommonWalletObject.pQ().df(paramString1).pR();; this.atE = paramCommonWalletObject) {
      return;
    }
  }
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\wallet\OfferWalletObject.class

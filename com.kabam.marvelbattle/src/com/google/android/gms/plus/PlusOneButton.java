  ...
  extends FrameLayout
{
  ...
  {
    int i = 0;
    paramContext = r.a("http://schemas.android.com/apk/lib/com.google.android.gms.plus", "annotation", paramContext, paramAttributeSet, true, false, "PlusOneButton");
  ...
  {
    int i = 0;
    paramContext = r.a("http://schemas.android.com/apk/lib/com.google.android.gms.plus", "size", paramContext, paramAttributeSet, true, false, "PlusOneButton");
    ...
    for (;;)
    {
      ...
      if ("MEDIUM".equalsIgnoreCase(paramContext)) {
        i = 1;
      } else if ("TALL".equalsIgnoreCase(paramContext)) {
        i = 2;
      } else {
        i = 3;
      }
    ...
    implements View.OnClickListener, PlusOneButton.OnPlusOneClickListener
  {
    ...
    {
      this.alp = paramOnPlusOneClickListener;
    }
    ...
    public void onClick(View paramView)
    {
      ...
      if (this.alp != null) {
        this.alp.onPlusOneClick(paramView);
      }
      for (;;)
      {
        return;
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\plus\PlusOneButton.class

  ...
  static boolean a(AppState paramAppState, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      if (paramAppState != paramObject)
      {
        ...
        {
          bool1 = bool2;
          if (n.equal(((AppState)paramObject).getConflictData(), paramAppState.getConflictData())) {}
        }
        else
        {
          bool1 = false;
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\appstate\a.class

...
public abstract interface GoogleApiClient
{
  ...
  public static final class Builder
  {
    ...
    public GoogleApiClient build()
    {
      ...
      label39:
      for (Object localObject = gl();; localObject = new b(this.mContext, this.IH, gk(), this.IN, this.IS, this.IT, -1, this.IR))
      {
        return (GoogleApiClient)localObject;
        bool = false;
        break;
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\common\api\GoogleApiClient.class

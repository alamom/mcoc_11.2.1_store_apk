    ...
    for (;;)
    {
      ...
      if (paramString1 != null)
      {
        ...
        if (paramString1.startsWith("@string/"))
        {
          ...
          if (paramBoolean1)
          {
            str2 = paramString1.substring("@string/".length());
      ...
      try
      {
        ...
        paramContext.<init>();
        localResources.getValue(str1 + ":string/" + str2, paramAttributeSet, true);
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\common\internal\r.class

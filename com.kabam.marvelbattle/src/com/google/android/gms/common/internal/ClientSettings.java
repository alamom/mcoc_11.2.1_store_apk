...
public final class ClientSettings
{
    ...
    implements SafeParcelable
  {
    ...
    {
      if (this.Dd != null) {}
      for (String str = this.Dd;; str = "<<default account>>") {
        return str;
      }
    }
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\common\internal\ClientSettings.class

  ...
  implements Game
{
    ...
    extends GameEntityCreator
  {
    public GameEntity cd(Parcel paramParcel)
    {
      ...
      {
        paramParcel = super.cd(paramParcel);
        return paramParcel;
      }
      ...
      {
        paramParcel = new GameEntity(5, str5, str3, str6, str4, str1, str2, (Uri)localObject1, (Uri)localObject2, (Uri)localObject3, bool1, bool2, paramParcel.readString(), paramParcel.readInt(), paramParcel.readInt(), paramParcel.readInt(), false, false, null, null, null, false, false, false, null);
        break;
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\games\GameEntity.class

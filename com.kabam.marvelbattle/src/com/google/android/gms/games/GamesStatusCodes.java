...
public final class GamesStatusCodes
{
  ...
  public static String getStatusString(int paramInt)
  {
    ...
    {
    default: 
      str = String.format("Status code (%d) not found!", new Object[] { Integer.valueOf(paramInt) });
    }
    for (;;)
    {
      return str;
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\games\GamesStatusCodes.class

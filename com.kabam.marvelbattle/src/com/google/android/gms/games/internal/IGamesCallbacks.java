    ...
    implements IGamesCallbacks
  {
    ...
    public static IGamesCallbacks aA(IBinder paramIBinder)
    {
      ...
      for (;;)
      {
        ...
        if ((localIInterface != null) && ((localIInterface instanceof IGamesCallbacks))) {
          paramIBinder = (IGamesCallbacks)localIInterface;
        } else {
      ...
      throws RemoteException
    {
      ...
      for (;;)
      {
        ...
        {
          a(paramInt1, (String)localObject1, bool1);
          paramParcel2.writeNoException();
          bool1 = bool2;
          break;
        }
      ...
      implements IGamesCallbacks
    {
        ...
        throws RemoteException
      {
        ...
        try
        {
          ...
          localParcel2.writeInt(paramInt);
          this.lb.transact(5034, localParcel2, localParcel1, 0);
        ...
        throws RemoteException
      {
        ...
        //   33: aload 4
        //   35: aload_2
        //   36: invokevirtual 91	android/os/Parcel:writeStringArray	([Ljava/lang/String;)V
        //   39: aload_0
        //   40: getfield 19	com/google/android/gms/games/internal/IGamesCallbacks$Stub$Proxy:lb	Landroid/os/IBinder;
        //   43: sipush 5026
        //   46: aload 4
        //   48: aload_3
        //   49: iconst_0
        ...
        //   start	length	slot	name	signature
        //   0	91	0	this	Proxy
        //   0	91	1	paramDataHolder	DataHolder
        //   0	91	2	paramArrayOfString	String[]
        ...
        throws RemoteException
      {
        ...
        //   33: aload 4
        //   35: iconst_0
        //   36: invokevirtual 99	android/os/Bundle:writeToParcel	(Landroid/os/Parcel;I)V
        //   39: aload_0
        //   40: getfield 19	com/google/android/gms/games/internal/IGamesCallbacks$Stub$Proxy:lb	Landroid/os/IBinder;
        //   43: sipush 8002
        //   46: aload 4
        ...
        throws RemoteException
      {
        ...
        try
        {
          localParcel2.writeInterfaceToken("com.google.android.gms.games.internal.IGamesCallbacks");
          localParcel2.writeInt(paramInt);
          this.lb.transact(5040, localParcel2, localParcel1, 0);
          localParcel1.readException();
          return;
        }
        finally
        ...
        throws RemoteException
      {
        ...
        try
        {
          ...
          localParcel2.writeInt(paramInt);
          localParcel2.writeString(paramString);
          this.lb.transact(5003, localParcel2, localParcel1, 0);
          localParcel1.readException();
          return;
        }
        finally
        ...
        throws RemoteException
      {
        ...
        try
        {
          localParcel2.writeInterfaceToken("com.google.android.gms.games.internal.IGamesCallbacks");
          localParcel2.writeString(paramString);
          this.lb.transact(8010, localParcel2, localParcel1, 0);
          localParcel1.readException();
          return;
        }
        finally
        ...
        throws RemoteException
      {
        ...
        try
        {
          ...
          localParcel2.writeInt(paramInt);
          localParcel2.writeString(paramString);
          this.lb.transact(5020, localParcel2, localParcel1, 0);
          localParcel1.readException();
          return;
        }
        finally
        ...
        throws RemoteException
      {
        ...
        try
        {
          localParcel2.writeInterfaceToken("com.google.android.gms.games.internal.IGamesCallbacks");
          localParcel2.writeString(paramString);
          this.lb.transact(8009, localParcel2, localParcel1, 0);
          localParcel1.readException();
          return;
        }
        finally
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\games\internal\IGamesCallbacks.class

  ...
  implements GameBadge
{
  ...
  static boolean a(GameBadge paramGameBadge, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      if (paramGameBadge != paramObject)
      {
        ...
        {
          bool1 = bool2;
          if (n.equal(((GameBadge)paramObject).getDescription(), paramGameBadge.getIconImageUri())) {}
        }
        else
        {
          bool1 = false;
    ...
    extends GameBadgeEntityCreator
  {
    public GameBadgeEntity ch(Parcel paramParcel)
    {
      ...
      {
        paramParcel = super.ch(paramParcel);
        return paramParcel;
      }
      ...
      {
        paramParcel = new GameBadgeEntity(1, i, str2, str1, paramParcel);
        break;
      }
    }
  }
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\games\internal\game\GameBadgeEntity.class

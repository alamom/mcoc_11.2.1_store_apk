  ...
  implements ExtendedGame
{
  ...
  ExtendedGameRef(DataHolder paramDataHolder, int paramInt1, int paramInt2)
  {
    ...
    for (this.aaJ = new SnapshotMetadataRef(paramDataHolder, paramInt1);; this.aaJ = null) {
      return;
    }
  }
  ...
  public ArrayList<GameBadge> kR()
  {
    ...
    for (;;)
    {
      ...
      localArrayList = new ArrayList(this.aaK);
      while (i < this.aaK)
      {
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\games\internal\game\ExtendedGameRef.class

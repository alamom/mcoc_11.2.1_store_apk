  ...
  static boolean a(MostRecentGameInfo paramMostRecentGameInfo, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      if (paramMostRecentGameInfo != paramObject)
      {
        ...
        {
          bool1 = bool2;
          if (n.equal(((MostRecentGameInfo)paramObject).lu(), paramMostRecentGameInfo.lu())) {}
        }
        else
        {
          bool1 = false;
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\games\internal\player\MostRecentGameInfoEntity.class

  ...
  implements Requests
{
  ...
  public ArrayList<GameRequest> getGameRequestsFromBundle(Bundle paramBundle)
  {
    ...
    {
      return paramBundle;
      ArrayList localArrayList = (ArrayList)paramBundle.get("requests");
      paramBundle = new ArrayList();
      int j = localArrayList.size();
      for (int i = 0; i < j; i++) {
        paramBundle.add((GameRequest)localArrayList.get(i));
      }
    }
  }
  ...
  {
    if (paramIntent == null) {}
    for (paramIntent = new ArrayList();; paramIntent = getGameRequestsFromBundle(paramIntent.getExtras())) {
      return paramIntent;
    }
  }
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\games\internal\api\RequestsImpl.class

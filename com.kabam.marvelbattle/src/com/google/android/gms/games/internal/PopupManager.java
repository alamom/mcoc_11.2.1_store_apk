...
public class PopupManager
{
  ...
  {
    if (kc.hC()) {}
    for (paramGamesClientImpl = new PopupManagerHCMR1(paramGamesClientImpl, paramInt);; paramGamesClientImpl = new PopupManager(paramGamesClientImpl, paramInt)) {
      return paramGamesClientImpl;
    }
  }
    ...
    implements View.OnAttachStateChangeListener, ViewTreeObserver.OnGlobalLayoutListener
  {
    ...
    private void m(View paramView)
    {
      ...
      this.Ya.right = (arrayOfInt[0] + k);
      this.Ya.bottom = (arrayOfInt[1] + j);
      if (this.Wy)
      {
        kM();
        this.Wy = false;
    ...
    public void l(View paramView)
    {
      ...
      this.Yd = null;
      Object localObject2 = this.XZ.getContext();
    ...
    public void onGlobalLayout()
    {
      ...
      {
        return;
        View localView = (View)this.Yd.get();
        if (localView != null) {
          m(localView);
        }
      }
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\games\internal\PopupManager.class

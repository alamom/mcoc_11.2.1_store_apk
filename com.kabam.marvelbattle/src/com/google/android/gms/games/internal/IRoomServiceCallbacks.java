    ...
    public static IRoomServiceCallbacks aE(IBinder paramIBinder)
    {
      ...
      for (;;)
      {
        ...
        if ((localIInterface != null) && ((localIInterface instanceof IRoomServiceCallbacks))) {
          paramIBinder = (IRoomServiceCallbacks)localIInterface;
        } else {
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\games\internal\IRoomServiceCallbacks.class

  ...
  implements Participant
{
  ...
  static boolean a(Participant paramParticipant, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      if (paramParticipant != paramObject)
      {
        ...
        {
          bool1 = bool2;
          if (n.equal(((Participant)paramObject).getParticipantId(), paramParticipant.getParticipantId())) {}
        }
        else
        {
          bool1 = false;
  ...
  {
    if (this.Wh == null) {}
    for (String str = this.NH;; str = this.Wh.getDisplayName()) {
      return str;
    }
  }
  ...
  {
    if (this.Wh == null) {}
    for (Uri localUri = this.Vi;; localUri = this.Wh.getHiResImageUri()) {
      return localUri;
    }
  }
  ...
  {
    if (this.Wh == null) {}
    for (String str = this.Vt;; str = this.Wh.getHiResImageUrl()) {
      return str;
    }
  }
  ...
  {
    if (this.Wh == null) {}
    for (Uri localUri = this.Vh;; localUri = this.Wh.getIconImageUri()) {
      return localUri;
    }
  }
  ...
  {
    if (this.Wh == null) {}
    for (String str = this.Vs;; str = this.Wh.getIconImageUrl()) {
      return str;
    }
  }
    ...
    extends ParticipantEntityCreator
  {
    public ParticipantEntity cm(Parcel paramParcel)
    {
      ...
      {
        paramParcel = super.cm(paramParcel);
        return paramParcel;
      }
      ...
      {
        paramParcel = new ParticipantEntity(3, str2, str1, (Uri)localObject1, (Uri)localObject2, j, str3, bool, paramParcel, 7, null, null, null);
        break;
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\games\multiplayer\ParticipantEntity.class

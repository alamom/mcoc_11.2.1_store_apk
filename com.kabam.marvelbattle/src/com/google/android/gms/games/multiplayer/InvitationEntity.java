  ...
  implements Invitation
{
  ...
  static boolean a(Invitation paramInvitation, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      if (paramInvitation != paramObject)
      {
        ...
        {
          bool1 = bool2;
          if (n.equal(Integer.valueOf(((Invitation)paramObject).getAvailableAutoMatchSlots()), Integer.valueOf(paramInvitation.getAvailableAutoMatchSlots()))) {}
        }
        else
        {
          bool1 = false;
    ...
    extends InvitationEntityCreator
  {
    public InvitationEntity cl(Parcel paramParcel)
    {
      ...
      for (paramParcel = super.cl(paramParcel);; paramParcel = new InvitationEntity(2, localGameEntity, str, l, k, localParticipantEntity, localArrayList, -1, 0))
      {
        return paramParcel;
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\games\multiplayer\InvitationEntity.class

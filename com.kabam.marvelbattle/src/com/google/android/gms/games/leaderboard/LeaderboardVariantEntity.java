  ...
  static boolean a(LeaderboardVariant paramLeaderboardVariant, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      if (paramLeaderboardVariant != paramObject)
      {
        ...
        {
          bool1 = bool2;
          if (n.equal(((LeaderboardVariant)paramObject).lE(), paramLeaderboardVariant.lE())) {}
        }
        else
        {
          bool1 = false;
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\games\leaderboard\LeaderboardVariantEntity.class

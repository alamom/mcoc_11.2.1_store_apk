  ...
  static boolean a(Leaderboard paramLeaderboard, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      if (paramLeaderboard != paramObject)
      {
        ...
        {
          bool1 = bool2;
          if (n.equal(((Leaderboard)paramObject).getVariants(), paramLeaderboard.getVariants())) {}
        }
        else
        {
          bool1 = false;
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\games\leaderboard\LeaderboardEntity.class

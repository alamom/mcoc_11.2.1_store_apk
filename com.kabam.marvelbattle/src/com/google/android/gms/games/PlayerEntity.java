  ...
  implements Player
{
  ...
  static boolean a(Player paramPlayer, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      if (paramPlayer != paramObject)
      {
        ...
        {
          bool1 = bool2;
          if (n.equal(((Player)paramObject).getLevelInfo(), paramPlayer.getLevelInfo())) {}
        }
        else
        {
          bool1 = false;
    ...
    extends PlayerEntityCreator
  {
    public PlayerEntity ce(Parcel paramParcel)
    {
      ...
      {
        paramParcel = super.ce(paramParcel);
        return paramParcel;
      }
      ...
      {
        paramParcel = new PlayerEntity(11, str2, str1, (Uri)localObject1, (Uri)localObject2, paramParcel.readLong(), -1, -1L, null, null, null, null, null, true);
        break;
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\games\PlayerEntity.class

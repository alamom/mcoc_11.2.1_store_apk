  ...
  implements SafeParcelable, Quest
{
  ...
  static boolean a(Quest paramQuest, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      if (paramQuest != paramObject)
      {
        ...
        {
          bool1 = bool2;
          if (n.equal(Integer.valueOf(((Quest)paramObject).getState()), Integer.valueOf(paramQuest.getState()))) {}
        }
        else
        {
          bool1 = false;
  ...
  {
    if (this.acY <= System.currentTimeMillis() + 1800000L) {}
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\games\quest\QuestEntity.class

  ...
  static boolean a(Milestone paramMilestone, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      if (paramMilestone != paramObject)
      {
        ...
        {
          bool1 = bool2;
          if (n.equal(((Milestone)paramObject).getEventId(), paramMilestone.getEventId())) {}
        }
        else
        {
          bool1 = false;
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\games\quest\MilestoneEntity.class

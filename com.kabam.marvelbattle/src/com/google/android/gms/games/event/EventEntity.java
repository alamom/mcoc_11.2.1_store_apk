  ...
  static boolean a(Event paramEvent, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      if (paramEvent != paramObject)
      {
        ...
        {
          bool1 = bool2;
          if (n.equal(Boolean.valueOf(((Event)paramObject).isVisible()), Boolean.valueOf(paramEvent.isVisible()))) {}
        }
        else
        {
          bool1 = false;
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\games\event\EventEntity.class

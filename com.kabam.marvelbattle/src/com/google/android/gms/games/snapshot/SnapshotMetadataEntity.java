  ...
  static boolean a(SnapshotMetadata paramSnapshotMetadata, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      if (paramSnapshotMetadata != paramObject)
      {
        ...
        {
          bool1 = bool2;
          if (n.equal(((SnapshotMetadata)paramObject).getUniqueName(), paramSnapshotMetadata.getUniqueName())) {}
        }
        else
        {
          bool1 = false;
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\games\snapshot\SnapshotMetadataEntity.class

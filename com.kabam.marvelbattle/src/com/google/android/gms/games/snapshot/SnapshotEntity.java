  ...
  implements SafeParcelable, Snapshot
{
  ...
  static boolean a(Snapshot paramSnapshot, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      if (paramSnapshot != paramObject)
      {
        ...
        {
          bool1 = bool2;
          if (n.equal(((Snapshot)paramObject).getSnapshotContents(), paramSnapshot.getSnapshotContents())) {}
        }
        else
        {
          bool1 = false;
  ...
  {
    if (isClosed()) {}
    for (Contents localContents = null;; localContents = this.adi.getContents()) {
  ...
  {
    if (isClosed()) {}
    for (SnapshotContents localSnapshotContents = null;; localSnapshotContents = this.adi) {
      return localSnapshotContents;
    }
  }
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\games\snapshot\SnapshotEntity.class

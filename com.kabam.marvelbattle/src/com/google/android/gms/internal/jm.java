  ...
  implements SafeParcelable
{
  ...
  public void ht()
  {
    ...
    while (localIterator1.hasNext())
    {
      ...
      HashMap localHashMap1 = (HashMap)this.MI.get(str2);
      HashMap localHashMap2 = new HashMap();
      Iterator localIterator2 = localHashMap1.keySet().iterator();
      while (localIterator2.hasNext())
      {
        String str1 = (String)localIterator2.next();
        localHashMap2.put(str1, ((ji.a)localHashMap1.get(str1)).hi());
      }
      this.MI.put(str2, localHashMap2);
    }
  }
  ...
  public String toString()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      HashMap localHashMap = (HashMap)this.MI.get(localObject);
      localObject = localHashMap.keySet().iterator();
      while (((Iterator)localObject).hasNext())
      {
        String str = (String)((Iterator)localObject).next();
        localStringBuilder.append("  ").append(str).append(": ");
        localStringBuilder.append(localHashMap.get(str));
      }
    }
    ...
    implements SafeParcelable
  {
    ...
    private static ArrayList<jm.b> a(HashMap<String, ji.a<?, ?>> paramHashMap)
    {
      ...
      for (paramHashMap = null;; paramHashMap = localArrayList)
      {
        return paramHashMap;
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\internal\jm.class

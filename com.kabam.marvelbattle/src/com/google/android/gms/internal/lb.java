  ...
  implements RecordingApi
{
  ...
  public PendingResult<Status> unsubscribe(GoogleApiClient paramGoogleApiClient, Subscription paramSubscription)
  {
    ...
    for (paramGoogleApiClient = unsubscribe(paramGoogleApiClient, paramSubscription.getDataSource());; paramGoogleApiClient = unsubscribe(paramGoogleApiClient, paramSubscription.getDataType())) {
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\internal\lb.class

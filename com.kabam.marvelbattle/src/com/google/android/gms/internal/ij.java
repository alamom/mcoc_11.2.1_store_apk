  ...
  extends e<in>
{
  ...
  private void c(BaseImplementation.b<Cast.ApplicationConnectionResult> paramb)
  {
    synchronized (GL)
    {
      if (this.GJ != null)
      {
        BaseImplementation.b localb = this.GJ;
        a locala = new com/google/android/gms/internal/ij$a;
        Status localStatus = new com/google/android/gms/common/api/Status;
        localStatus.<init>(2002);
        locala.<init>(localStatus);
        localb.b(locala);
      }
      this.GJ = paramb;
      return;
    ...
    throws IllegalArgumentException, RemoteException
  {
    ...
    catch (IllegalStateException localIllegalStateException)
    {
      for (;;)
      {
        Gr.a(localIllegalStateException, "Error unregistering namespace (%s): %s", new Object[] { paramString, localIllegalStateException.getMessage() });
      }
    }
  }
    ...
    extends io.a
  {
    ...
    private boolean ag(int paramInt)
    {
      synchronized ()
      {
        ...
        {
          BaseImplementation.b localb = ij.j(ij.this);
          Status localStatus = new com/google/android/gms/common/api/Status;
          localStatus.<init>(paramInt);
          localb.b(localStatus);
          ij.b(ij.this, null);
          bool = true;
          return bool;
        }
    ...
    public void a(ApplicationMetadata paramApplicationMetadata, String paramString1, String paramString2, boolean paramBoolean)
    {
      ...
      for (;;)
      {
        ...
        synchronized (ij.fI())
        {
          ...
          {
            BaseImplementation.b localb = ij.d(ij.this);
            ij.a locala = new com/google/android/gms/internal/ij$a;
            Status localStatus = new com/google/android/gms/common/api/Status;
            localStatus.<init>(0);
            locala.<init>(localStatus, paramApplicationMetadata, paramString1, paramString2, paramBoolean);
            localb.b(locala);
            ij.a(ij.this, null);
          }
        }
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\internal\ij.class

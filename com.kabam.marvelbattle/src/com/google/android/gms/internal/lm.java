  ...
  public void a(UserAddressRequest paramUserAddressRequest, int paramInt)
  {
    ...
    try
    {
      ...
      if (!TextUtils.isEmpty(this.Dd))
      {
        ...
        localAccount.<init>(this.Dd, "com.google");
        localBundle.putParcelable("com.google.android.gms.identity.intents.EXTRA_ACCOUNT", localAccount);
      }
      ...
      for (;;)
      {
        ...
        if (paramBundle.hasResolution()) {
          ...
          try
          {
            ...
            paramBundle = paramBundle.createPendingResult(paramInt, (Intent)localObject, 1073741824);
            if (paramBundle != null) {
              paramBundle.send(1);
            }
          }
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\internal\lm.class

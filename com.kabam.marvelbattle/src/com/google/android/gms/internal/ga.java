...
public class ga
{
  ...
  public void cP()
  {
    synchronized (this.mw)
    {
      if (this.vG != -1L)
      {
        Object localObject2 = new com/google/android/gms/internal/ga$a;
        ((a)localObject2).<init>();
        ((a)localObject2).cT();
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\internal\ga.class

    ...
    implements in
  {
    public static in M(IBinder paramIBinder)
    {
      ...
      for (;;)
      {
        ...
        if ((localIInterface != null) && ((localIInterface instanceof in))) {
          paramIBinder = (in)localIInterface;
        } else {
      ...
      implements in
    {
        ...
        throws RemoteException
      {
        ...
        //   20	61	5	i	int
        //   1	40	6	j	int
        //   85	8	7	localObject	Object
        //   6	82	8	localParcel	Parcel
        // Exception table:
        //   from	to	target	type
        //   8	15	85	finally
        //   22	35	85	finally
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\internal\in.class

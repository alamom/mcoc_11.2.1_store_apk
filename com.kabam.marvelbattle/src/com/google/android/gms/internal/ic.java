    ...
    public static ic J(IBinder paramIBinder)
    {
      ...
      for (;;)
      {
        ...
        if ((localIInterface != null) && ((localIInterface instanceof ic))) {
          paramIBinder = (ic)localIInterface;
        } else {
      ...
      implements ic
    {
        ...
        throws RemoteException
      {
        ...
        try
        {
          ...
          this.lb.transact(5005, localParcel2, localParcel1, 0);
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\internal\ic.class

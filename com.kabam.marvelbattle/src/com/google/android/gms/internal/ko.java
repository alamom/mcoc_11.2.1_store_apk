    ...
    implements ko
  {
    ...
    public static ko ar(IBinder paramIBinder)
    {
      ...
      for (;;)
      {
        ...
        if ((localIInterface != null) && ((localIInterface instanceof ko))) {
          paramIBinder = (ko)localIInterface;
        } else {
      ...
      implements ko
    {
        ...
        throws RemoteException
      {
        ...
        //   29: aload_0
        //   30: getfield 18	com/google/android/gms/internal/ko$a$a:lb	Landroid/os/IBinder;
        //   33: iconst_1
        //   34: aload_2
        //   35: aload_3
        //   36: iconst_0
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\internal\ko.class

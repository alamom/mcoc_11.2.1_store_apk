...
public abstract class iv<T>
{
  ...
  public static void H(Context paramContext)
  {
    synchronized (mw)
    {
      if (JN == null)
      {
        b localb = new com/google/android/gms/internal/iv$b;
        localb.<init>(paramContext.getContentResolver());
        JN = localb;
      }
      return;
    }
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\internal\iv.class

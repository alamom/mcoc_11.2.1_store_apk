  ...
  public void bS()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        b("onScreenInfoChanged", localJSONObject.put("width", i).put("height", j).put("density", localDisplayMetrics.density).put("rotation", localDisplay.getRotation()));
      }
    ...
    for (;;)
    {
      synchronized (this.mw)
      {
        ...
        if ((this.qr.widthPixels > paramInt1) || (this.qr.heightPixels > paramInt2))
        {
          ...
          gs.W("Not enough space to show ad. Needs " + (int)(this.qr.widthPixels / f) + "x" + (int)(this.qr.heightPixels / f) + " dp, but only has " + (int)(i / f) + "x" + (int)(j / f) + " dp.");
          if (getVisibility() != 8) {
            setVisibility(4);
          }
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\internal\gv.class

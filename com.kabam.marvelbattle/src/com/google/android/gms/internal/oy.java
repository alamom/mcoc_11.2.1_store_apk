    ...
    extends oy.a
  {
    ...
    public void a(int paramInt, FullWallet paramFullWallet, Bundle paramBundle)
    {
      ...
      for (;;)
      {
        try
        {
          ((ConnectionResult)localObject).startResolutionForResult(oy.b(oy.this), this.Lu);
          return;
        }
        ...
        if (((ConnectionResult)localObject).isSuccess())
        {
          ...
          paramFullWallet = oy.b(oy.this).createPendingResult(this.Lu, paramBundle, 1073741824);
    ...
    public void a(int paramInt, MaskedWallet paramMaskedWallet, Bundle paramBundle)
    {
      ...
      for (;;)
      {
        ...
        if (((ConnectionResult)localObject).isSuccess())
        {
          ...
          paramMaskedWallet = oy.b(oy.this).createPendingResult(this.Lu, paramBundle, 1073741824);
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\internal\oy.class

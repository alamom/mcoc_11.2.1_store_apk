    ...
    implements id
  {
    public static id K(IBinder paramIBinder)
    {
      ...
      for (;;)
      {
        ...
        if ((localIInterface != null) && ((localIInterface instanceof id))) {
          paramIBinder = (id)localIInterface;
        } else {
      ...
      implements id
    {
        ...
        throws RemoteException
      {
        ...
        //   39: aload_0
        //   40: getfield 18	com/google/android/gms/internal/id$a$a:lb	Landroid/os/IBinder;
        //   43: sipush 5007
        //   46: aload 4
        //   48: aload_3
        //   49: iconst_0
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\internal\id.class

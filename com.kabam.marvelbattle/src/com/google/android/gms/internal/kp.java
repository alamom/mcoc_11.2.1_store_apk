    ...
    public static kp as(IBinder paramIBinder)
    {
      ...
      for (;;)
      {
        ...
        if ((localIInterface != null) && ((localIInterface instanceof kp))) {
          paramIBinder = (kp)localIInterface;
        } else {
      ...
      implements kp
    {
        ...
        throws RemoteException
      {
        ...
        for (;;)
        {
          try
          {
            localParcel2.writeInterfaceToken("com.google.android.gms.fitness.internal.IGoogleFitnessService");
            if (paramDataDeleteRequest != null)
            {
              localParcel2.writeInt(1);
              paramDataDeleteRequest.writeToParcel(localParcel2, 0);
              if (paramkt != null)
              {
                paramDataDeleteRequest = paramkt.asBinder();
                localParcel2.writeStrongBinder(paramDataDeleteRequest);
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\internal\kp.class

  ...
  extends IInterface
{
    ...
    implements os
  {
    ...
    public static os bK(IBinder paramIBinder)
    {
      ...
      for (;;)
      {
        ...
        if ((localIInterface != null) && ((localIInterface instanceof os))) {
          paramIBinder = (os)localIInterface;
        } else {
      ...
      throws RemoteException
    {
      ...
      {
        a(paramInt2, paramInt1, paramParcel1);
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\internal\os.class

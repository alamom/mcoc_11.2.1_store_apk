    ...
    implements ln
  {
    ...
    public static ln aG(IBinder paramIBinder)
    {
      ...
      for (;;)
      {
        ...
        if ((localIInterface != null) && ((localIInterface instanceof ln))) {
          paramIBinder = (ln)localIInterface;
        } else {
      ...
      implements ln
    {
        ...
        throws RemoteException
      {
        ...
        //   35: aload_0
        //   36: getfield 18	com/google/android/gms/internal/ln$a$a:lb	Landroid/os/IBinder;
        //   39: iconst_2
        //   40: aload_3
        //   41: aload 4
        //   43: iconst_0
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\internal\ln.class

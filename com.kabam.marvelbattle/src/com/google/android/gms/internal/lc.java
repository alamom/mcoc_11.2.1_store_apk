  ...
  implements SensorsApi
{
  ...
  public PendingResult<Status> remove(GoogleApiClient paramGoogleApiClient, final OnDataPointListener paramOnDataPointListener)
  {
    ...
    if (locall == null) {}
    for (paramGoogleApiClient = new ku(Status.Jv);; paramGoogleApiClient = a(paramGoogleApiClient, new q(locall, null), new b()
        {
          public void jd()
          {
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\internal\lc.class

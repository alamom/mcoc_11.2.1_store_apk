  ...
  implements SafeParcelable
{
  ...
  private static <E> Set<E> f(List<E> paramList)
  {
    ...
    for (paramList = Collections.emptySet();; paramList = Collections.unmodifiableSet(new HashSet(paramList))) {
      return paramList;
    }
  }
  ...
  public boolean equals(Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        if ((!this.afw.equals(((mj)paramObject).afw)) || (this.aft != ((mj)paramObject).aft) || (!this.afx.equals(((mj)paramObject).afx)) || (!this.afy.equals(((mj)paramObject).afy))) {
          bool = false;
        }
      }
    }
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\internal\mj.class

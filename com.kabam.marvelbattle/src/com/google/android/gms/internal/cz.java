  ...
  extends cu.a
{
    ...
    throws RemoteException
  {
    if (paramString1 != null) {
      try
      {
        ...
        paramString2.<init>(((JSONObject)localObject).length());
    ...
    throws RemoteException
  {
    ...
    try
    {
      MediationInterstitialAdapter localMediationInterstitialAdapter = (MediationInterstitialAdapter)this.qG;
      da localda = new com/google/android/gms/internal/da;
      localda.<init>(paramcv);
      localMediationInterstitialAdapter.requestInterstitialAd(localda, (Activity)e.f(paramd), b(paramString1, paramav.nX, paramString2), db.d(paramav), this.qH);
      return;
    }
    ...
    throws RemoteException
  {
    ...
    try
    {
      MediationBannerAdapter localMediationBannerAdapter = (MediationBannerAdapter)this.qG;
      da localda = new com/google/android/gms/internal/da;
      localda.<init>(paramcv);
      localMediationBannerAdapter.requestBannerAd(localda, (Activity)e.f(paramd), b(paramString1, paramav.nX, paramString2), db.b(paramay), db.d(paramav), this.qH);
      return;
    }
    catch (Throwable paramd)
    {
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\internal\cz.class

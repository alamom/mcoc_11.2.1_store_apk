  ...
  implements ContainerHolder
{
  ...
  String getContainerId()
  {
    ...
    for (String str = "";; str = this.aok.getContainerId()) {
      return str;
    }
  }
  ...
  String nU()
  {
    ...
    for (String str = "";; str = this.aon.nU()) {
      return str;
    }
  }
  ...
  public void setContainerAvailableListener(ContainerHolder.ContainerAvailableListener paramContainerAvailableListener)
  {
    for (;;)
    {
      try
      {
        ...
        localb = new com/google/android/gms/tagmanager/n$b;
      }
      finally {}
      b localb;
      localb.<init>(this, paramContainerAvailableListener, this.IH);
      this.aom = localb;
      if (this.aol != null) {
        nV();
      }
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\tagmanager\n.class

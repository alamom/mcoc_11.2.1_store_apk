  ...
  extends FrameLayout
{
  ...
  public final StreetViewPanorama getStreetViewPanorama()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        localStreetViewPanorama = new com/google/android/gms/maps/StreetViewPanorama;
        localStreetViewPanorama.<init>(((b)this.ajq.it()).mH().getStreetViewPanorama());
        this.ajh = localStreetViewPanorama;
        localStreetViewPanorama = this.ajh;
      }
    ...
    extends a<StreetViewPanoramaView.b>
  {
    ...
    public void mA()
    {
      ...
      try
      {
        ...
        f localf = this.aiT;
        StreetViewPanoramaView.b localb = new com/google/android/gms/maps/StreetViewPanoramaView$b;
        localb.<init>(this.aiY, localIStreetViewPanoramaViewDelegate);
        localf.a(localb);
        return;
      }
      catch (RemoteException localRemoteException)
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\maps\StreetViewPanoramaView.class

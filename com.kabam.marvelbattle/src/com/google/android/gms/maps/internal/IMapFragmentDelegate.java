    ...
    public static IMapFragmentDelegate aT(IBinder paramIBinder)
    {
      ...
      for (;;)
      {
        ...
        if ((localIInterface != null) && ((localIInterface instanceof IMapFragmentDelegate))) {
          paramIBinder = (IMapFragmentDelegate)localIInterface;
        } else {
      ...
      implements IMapFragmentDelegate
    {
        ...
        throws RemoteException
      {
        ...
        try
        {
          ...
          IGoogleMapDelegate localIGoogleMapDelegate = IGoogleMapDelegate.a.aQ(localParcel1.readStrongBinder());
          ...
          try
          {
            ...
            if (paramd != null)
            {
              ...
              if (paramGoogleMapOptions != null)
              {
                ...
                paramGoogleMapOptions.writeToParcel(localParcel2, 0);
                if (paramBundle == null) {
                  break label127;
                }
                localParcel2.writeInt(1);
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\maps\internal\IMapFragmentDelegate.class

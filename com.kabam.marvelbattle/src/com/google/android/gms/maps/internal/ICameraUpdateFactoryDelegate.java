    ...
    implements ICameraUpdateFactoryDelegate
  {
    public static ICameraUpdateFactoryDelegate aN(IBinder paramIBinder)
    {
      ...
      for (;;)
      {
        ...
        if ((localIInterface != null) && ((localIInterface instanceof ICameraUpdateFactoryDelegate))) {
          paramIBinder = (ICameraUpdateFactoryDelegate)localIInterface;
        } else {
      ...
      implements ICameraUpdateFactoryDelegate
    {
        ...
        throws RemoteException
      {
        ...
        //   27: aload 4
        //   29: iconst_0
        //   30: invokevirtual 79	com/google/android/gms/maps/model/LatLngBounds:writeToParcel	(Landroid/os/Parcel;I)V
        //   33: aload 4
        //   35: iload_2
        //   36: invokevirtual 41	android/os/Parcel:writeInt	(I)V
        //   39: aload_0
        //   40: getfield 18	com/google/android/gms/maps/internal/ICameraUpdateFactoryDelegate$a$a:lb	Landroid/os/IBinder;
        //   43: bipush 10
        //   45: aload 4
        //   47: aload_3
        //   48: iconst_0
        ...
        //   59: aload_3
        //   60: invokevirtual 59	android/os/Parcel:readStrongBinder	()Landroid/os/IBinder;
        //   63: invokestatic 65	com/google/android/gms/dynamic/d$a:am	(Landroid/os/IBinder;)Lcom/google/android/gms/dynamic/d;
        //   66: astore_1
        //   67: aload_3
        ...
        //   92: aload 4
        //   94: invokevirtual 68	android/os/Parcel:recycle	()V
        //   97: aload_1
        //   98: athrow
        // Local variable table:
        //   start	length	slot	name	signature
        //   0	99	0	this	a
        //   0	99	1	paramLatLngBounds	LatLngBounds
        //   0	99	2	paramInt	int
        //   8	81	3	localParcel1	Parcel
        //   3	90	4	localParcel2	Parcel
        // Exception table:
        //   from	to	target	type
        //   9	16	87	finally
        //   20	33	87	finally
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\maps\internal\ICameraUpdateFactoryDelegate.class

    ...
    public static IMapViewDelegate aU(IBinder paramIBinder)
    {
      ...
      for (;;)
      {
        ...
        if ((localIInterface != null) && ((localIInterface instanceof IMapViewDelegate))) {
          paramIBinder = (IMapViewDelegate)localIInterface;
        } else {
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\maps\internal\IMapViewDelegate.class

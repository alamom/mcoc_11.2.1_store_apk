    ...
    public static ILocationSourceDelegate aS(IBinder paramIBinder)
    {
      ...
      for (;;)
      {
        ...
        if ((localIInterface != null) && ((localIInterface instanceof ILocationSourceDelegate))) {
          paramIBinder = (ILocationSourceDelegate)localIInterface;
        } else {
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\maps\internal\ILocationSourceDelegate.class

  ...
  extends FrameLayout
{
  ...
  public final GoogleMap getMap()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        localGoogleMap = new com/google/android/gms/maps/GoogleMap;
        localGoogleMap.<init>(((a)this.aiU.it()).mB().getMap());
        this.aiR = localGoogleMap;
        localGoogleMap = this.aiR;
      }
    ...
    extends a<MapView.a>
  {
    ...
    public void mA()
    {
      ...
      try
      {
        ...
        f localf = this.aiT;
        MapView.a locala = new com/google/android/gms/maps/MapView$a;
        locala.<init>(this.aiY, localIMapViewDelegate);
        localf.a(locala);
        return;
      }
      catch (RemoteException localRemoteException)
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\maps\MapView.class

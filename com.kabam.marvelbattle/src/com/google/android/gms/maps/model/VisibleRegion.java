  ...
  implements SafeParcelable
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        if ((!this.nearLeft.equals(((VisibleRegion)paramObject).nearLeft)) || (!this.nearRight.equals(((VisibleRegion)paramObject).nearRight)) || (!this.farLeft.equals(((VisibleRegion)paramObject).farLeft)) || (!this.farRight.equals(((VisibleRegion)paramObject).farRight)) || (!this.latLngBounds.equals(((VisibleRegion)paramObject).latLngBounds))) {
          bool = false;
        }
      }
    }
  ...
  public int hashCode()
  {
    return n.hashCode(new Object[] { this.nearLeft, this.nearRight, this.farLeft, this.farRight, this.latLngBounds });
  }
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\maps\model\VisibleRegion.class

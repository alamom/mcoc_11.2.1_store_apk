  ...
  public boolean equals(Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        if ((Float.floatToIntBits(this.zoom) != Float.floatToIntBits(((StreetViewPanoramaCamera)paramObject).zoom)) || (Float.floatToIntBits(this.tilt) != Float.floatToIntBits(((StreetViewPanoramaCamera)paramObject).tilt)) || (Float.floatToIntBits(this.bearing) != Float.floatToIntBits(((StreetViewPanoramaCamera)paramObject).bearing))) {
          bool = false;
        }
      }
    }
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\maps\model\StreetViewPanoramaCamera.class

    ...
    public static IPolylineDelegate bw(IBinder paramIBinder)
    {
      ...
      for (;;)
      {
        ...
        if ((localIInterface != null) && ((localIInterface instanceof IPolylineDelegate))) {
          paramIBinder = (IPolylineDelegate)localIInterface;
        } else {
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\maps\model\internal\IPolylineDelegate.class

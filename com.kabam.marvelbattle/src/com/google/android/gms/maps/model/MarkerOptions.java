  ...
  implements SafeParcelable
{
  ...
  {
    if (this.ake == null) {}
    for (IBinder localIBinder = null;; localIBinder = this.ake.mo().asBinder()) {
      return localIBinder;
    }
  }
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\maps\model\MarkerOptions.class

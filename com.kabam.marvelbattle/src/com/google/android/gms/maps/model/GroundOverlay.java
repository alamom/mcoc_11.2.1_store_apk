...
public final class GroundOverlay
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        bool = this.ajN.a(((GroundOverlay)paramObject).ajN);
      }
  ...
  public LatLngBounds getBounds()
  {
    try
    {
      LatLngBounds localLatLngBounds = this.ajN.getBounds();
  ...
  public LatLng getPosition()
  {
    try
    {
      LatLng localLatLng = this.ajN.getPosition();
      return localLatLng;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public boolean isVisible()
  {
    try
    {
      boolean bool = this.ajN.isVisible();
      return bool;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public void setBearing(float paramFloat)
  {
    try
    {
      this.ajN.setBearing(paramFloat);
      return;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public void setDimensions(float paramFloat)
  {
    try
    {
      this.ajN.setDimensions(paramFloat);
      return;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public void setDimensions(float paramFloat1, float paramFloat2)
  {
    try
    {
      this.ajN.a(paramFloat1, paramFloat2);
      return;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public void setImage(BitmapDescriptor paramBitmapDescriptor)
  {
    try
    {
      this.ajN.m(paramBitmapDescriptor.mo());
      return;
    }
  ...
  public void setPosition(LatLng paramLatLng)
  {
    try
    {
      this.ajN.setPosition(paramLatLng);
      return;
    }
  ...
  public void setPositionFromBounds(LatLngBounds paramLatLngBounds)
  {
    try
    {
      this.ajN.setPositionFromBounds(paramLatLngBounds);
      return;
    }
  ...
  public void setTransparency(float paramFloat)
  {
    try
    {
      this.ajN.setTransparency(paramFloat);
      return;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public void setVisible(boolean paramBoolean)
  {
    try
    {
      this.ajN.setVisible(paramBoolean);
      return;
    }
    catch (RemoteException localRemoteException)
    {
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\maps\model\GroundOverlay.class

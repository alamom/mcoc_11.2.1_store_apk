  ...
  implements SafeParcelable
{
  ...
  {
    if (this.Dw.size() == 0) {}
    for (Object localObject = null;; localObject = ((StringBuffer)localObject).toString())
    {
      return (String)localObject;
      localObject = new StringBuffer();
      for (int i = 0; i < this.Dw.size(); i++)
      {
        ((StringBuffer)localObject).append((String)this.Dw.get(i));
        if (i != this.Dw.size() - 1) {
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\android\gms\auth\api\GoogleAuthApiRequest.class

  ...
  implements JsonSerializer<java.util.Date>, JsonDeserializer<java.util.Date>
{
  ...
  public JsonElement serialize(java.util.Date paramDate, Type arg2, JsonSerializationContext paramJsonSerializationContext)
  {
    synchronized (this.localFormat)
    {
      paramDate = this.enUsFormat.format(paramDate);
      paramJsonSerializationContext = new com/google/gson/JsonPrimitive;
      paramJsonSerializationContext.<init>(paramDate);
      return paramJsonSerializationContext;
    }
  }
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\gson\DefaultDateTypeAdapter.class

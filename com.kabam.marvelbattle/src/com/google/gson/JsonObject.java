  ...
  extends JsonElement
{
  ...
  {
    if (paramObject == null) {}
    for (paramObject = JsonNull.INSTANCE;; paramObject = new JsonPrimitive(paramObject)) {
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\google\gson\JsonObject.class

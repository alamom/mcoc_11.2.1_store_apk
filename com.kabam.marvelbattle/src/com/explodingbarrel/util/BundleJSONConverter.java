    ...
    SETTERS.put(JSONArray.class, new Setter()
    {
        ...
        throws JSONException
      {
        ...
        if (localJSONArray.length() == 0) {
          paramAnonymousBundle.putStringArrayList(paramAnonymousString, (ArrayList)paramAnonymousObject);
        }
        for (;;)
        {
          return;
          ...
          while (i < localJSONArray.length())
          {
            ...
            {
              ((ArrayList)paramAnonymousObject).add((String)localObject);
              i++;
            }
            else
            {
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\com\explodingbarrel\util\BundleJSONConverter.class

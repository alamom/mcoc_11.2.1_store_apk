    ...
    public static IResultReceiver asInterface(IBinder paramIBinder)
    {
      ...
      for (;;)
      {
        ...
        if ((localIInterface != null) && ((localIInterface instanceof IResultReceiver))) {
          paramIBinder = (IResultReceiver)localIInterface;
        } else {
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\android\support\v4\os\IResultReceiver.class

  ...
  implements Parcelable
{
  ...
  public BackStackRecord instantiate(FragmentManagerImpl paramFragmentManagerImpl)
  {
    ...
    int i = 0;
    for (int k = 0; i < this.mOps.length; k++)
    {
      ...
      for (localOp.fragment = ((Fragment)paramFragmentManagerImpl.mActive.get(j));; localOp.fragment = null)
      {
        ...
        localObject = this.mOps;
        j = m + 1;
        localOp.exitAnim = localObject[m];
        localObject = this.mOps;
        i = j + 1;
        localOp.popEnterAnim = localObject[j];
        localObject = this.mOps;
        j = i + 1;
        localOp.popExitAnim = localObject[i];
        localObject = this.mOps;
        i = j + 1;
        int n = localObject[j];
        j = i;
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\android\support\v4\app\BackStackState.class

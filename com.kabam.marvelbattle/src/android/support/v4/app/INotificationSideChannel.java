    ...
    public static INotificationSideChannel asInterface(IBinder paramIBinder)
    {
      ...
      for (;;)
      {
        ...
        if ((localIInterface != null) && ((localIInterface instanceof INotificationSideChannel))) {
          paramIBinder = (INotificationSideChannel)localIInterface;
        } else {
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\android\support\v4\app\INotificationSideChannel.class

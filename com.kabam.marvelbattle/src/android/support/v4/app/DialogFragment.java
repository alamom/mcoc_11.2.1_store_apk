  ...
  implements DialogInterface.OnCancelListener, DialogInterface.OnDismissListener
{
  ...
  public LayoutInflater getLayoutInflater(Bundle paramBundle)
  {
    if (!this.mShowsDialog) {
      paramBundle = super.getLayoutInflater(paramBundle);
    }
    for (;;)
    {
      return paramBundle;
      ...
      {
        paramBundle = (LayoutInflater)this.mHost.getContext().getSystemService("layout_inflater");
      }
    }
  }
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\android\support\v4\app\DialogFragment.class

  ...
  implements FragmentManager.BackStackEntry, Runnable
{
  ...
  private boolean configureTransitions(int paramInt, TransitionState paramTransitionState, boolean paramBoolean, SparseArray<Fragment> paramSparseArray1, SparseArray<Fragment> paramSparseArray2)
  {
    ...
    for (;;)
    {
      ...
      for (paramSparseArray1 = ((Fragment)localObject5).mEnterTransitionCallback;; paramSparseArray1 = ((Fragment)localObject3).mEnterTransitionCallback)
      {
        ...
        prepareSharedElementTransition(paramTransitionState, localViewGroup, localObject1, (Fragment)localObject3, (Fragment)localObject5, paramBoolean, localArrayList1);
        paramSparseArray2 = (SparseArray<Fragment>)localObject1;
      ...
      for (bool = ((Fragment)localObject3).getAllowReturnTransitionOverlap();; bool = ((Fragment)localObject3).getAllowEnterTransitionOverlap())
      {
        ...
        if (localObject3 != null)
        {
          FragmentTransitionCompat21.addTransitionTargets(localObject4, paramSparseArray2, localViewGroup, (FragmentTransitionCompat21.ViewRetriever)localObject5, paramTransitionState.nonExistentView, paramTransitionState.enteringEpicenterView, paramTransitionState.nameOverrides, localArrayList2, paramSparseArray1, (Map)localObject6, localArrayList1);
          ...
          FragmentTransitionCompat21.cleanupTransitions(localViewGroup, paramTransitionState.nonExistentView, localObject4, localArrayList2, localObject2, (ArrayList)localObject1, paramSparseArray2, localArrayList1, localObject3, paramTransitionState.hiddenFragmentViews, (Map)localObject6);
        }
        if (localObject3 == null) {
          break label488;
        }
  ...
  private static Object getSharedElementTransition(Fragment paramFragment1, Fragment paramFragment2, boolean paramBoolean)
  {
    ...
    {
      paramFragment1 = FragmentTransitionCompat21.wrapSharedElementTransition(paramFragment1);
      break;
    }
  }
  ...
  private ArrayMap<String, View> remapSharedElements(TransitionState paramTransitionState, Fragment paramFragment, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      localArrayMap1 = remapNames(this.mSharedElementSourceNames, this.mSharedElementTargetNames, localArrayMap2);
      break;
      label100:
      if (paramFragment.mExitTransitionCallback != null) {
  ...
  private static void setNameOverrides(TransitionState paramTransitionState, ArrayList<String> paramArrayList1, ArrayList<String> paramArrayList2)
  {
    if (paramArrayList1 != null) {
      ...
      {
        String str2 = (String)paramArrayList1.get(i);
        String str1 = (String)paramArrayList2.get(i);
        setNameOverride(paramTransitionState.nameOverrides, str2, str1);
      }
    }
  }
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\android\support\v4\app\BackStackRecord.class

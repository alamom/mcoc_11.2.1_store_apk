...
public class NotificationCompat
{
  ...
  private static Notification[] getNotificationArrayFromBundle(Bundle paramBundle, String paramString)
  {
    ...
    for (paramBundle = (Notification[])arrayOfParcelable;; paramBundle = arrayOfNotification)
    {
      return paramBundle;
    ...
    extends NotificationCompatBase.Action
  {
      ...
      implements NotificationCompat.Action.Extender
    {
      ...
      {
        if (paramBoolean) {}
        for (this.mFlags |= paramInt;; this.mFlags &= (paramInt ^ 0xFFFFFFFF)) {
          return;
        }
      }
    ...
    implements NotificationCompat.Extender
  {
    ...
    public CarExtender(Notification paramNotification)
    {
      ...
      for (;;)
      {
        ...
        for (paramNotification = null;; paramNotification = NotificationCompat.getExtras(paramNotification).getBundle("android.car.EXTENSIONS"))
        {
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\android\support\v4\app\NotificationCompat.class

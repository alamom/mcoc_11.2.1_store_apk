    ...
    public static IMediaControllerCallback asInterface(IBinder paramIBinder)
    {
      ...
      for (;;)
      {
        ...
        if ((localIInterface != null) && ((localIInterface instanceof IMediaControllerCallback))) {
          paramIBinder = (IMediaControllerCallback)localIInterface;
        } else {
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\android\support\v4\media\session\IMediaControllerCallback.class

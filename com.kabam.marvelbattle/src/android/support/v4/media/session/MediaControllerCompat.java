...
public final class MediaControllerCompat
{
    ...
    implements MediaControllerCompat.MediaControllerImpl
  {
    ...
    public MediaMetadataCompat getMetadata()
    {
      ...
      if (localObject != null) {}
      for (localObject = MediaMetadataCompat.fromMediaMetadata(localObject);; localObject = null) {
    ...
    public PlaybackStateCompat getPlaybackState()
    {
      ...
      if (localObject != null) {}
      for (localObject = PlaybackStateCompat.fromPlaybackState(localObject);; localObject = null) {
    ...
    public MediaControllerCompat.TransportControls getTransportControls()
    {
      ...
      if (localObject != null) {}
      for (localObject = new MediaControllerCompat.TransportControlsApi21(localObject);; localObject = null) {
    ...
    extends MediaControllerCompat.MediaControllerImplApi21
  {
    ...
    public MediaControllerCompat.TransportControls getTransportControls()
    {
      Object localObject = MediaControllerCompatApi21.getTransportControls(this.mControllerObj);
      if (localObject != null) {}
      for (localObject = new MediaControllerCompat.TransportControlsApi23(localObject);; localObject = null) {
        return (MediaControllerCompat.TransportControls)localObject;
      }
    }
  }
    ...
    implements MediaControllerCompat.MediaControllerImpl
  {
    ...
    public MediaControllerCompat.PlaybackInfo getPlaybackInfo()
    {
      try
      {
        ...
        MediaControllerCompat.PlaybackInfo localPlaybackInfo = new android/support/v4/media/session/MediaControllerCompat$PlaybackInfo;
        localPlaybackInfo.<init>(localParcelableVolumeInfo.volumeType, localParcelableVolumeInfo.audioStream, localParcelableVolumeInfo.controlType, localParcelableVolumeInfo.maxVolume, localParcelableVolumeInfo.currentVolume);
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\android\support\v4\media\session\MediaControllerCompat.class

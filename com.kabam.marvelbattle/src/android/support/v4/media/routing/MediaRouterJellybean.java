...
class MediaRouterJellybean
{
  ...
  public static List getCategories(Object paramObject)
  {
    ...
    int j = localMediaRouter.getCategoryCount();
    paramObject = new ArrayList(j);
    for (int i = 0; i < j; i++) {
      ((List)paramObject).add(localMediaRouter.getCategoryAt(i));
    }
  ...
  {
    MediaRouter localMediaRouter = (MediaRouter)paramObject;
    int j = localMediaRouter.getRouteCount();
    paramObject = new ArrayList(j);
    for (int i = 0; i < j; i++) {
      ((List)paramObject).add(localMediaRouter.getRouteAt(i));
    }
    return (List)paramObject;
  }
  ...
  public static final class GetDefaultRouteWorkaround
  {
    ...
    public Object getDefaultRoute(Object paramObject)
    {
      ...
      try
      {
        paramObject = this.mGetSystemAudioRouteMethod.invoke(localMediaRouter, new Object[0]);
        return paramObject;
      }
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\android\support\v4\media\routing\MediaRouterJellybean.class

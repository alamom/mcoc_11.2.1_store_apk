    ...
    public boolean isConnecting(Object paramObject)
    {
      ...
      if (this.mGetStatusCodeMethod != null) {
        for (;;)
        {
          try
          {
            int j = ((Integer)this.mGetStatusCodeMethod.invoke(paramObject, new Object[0])).intValue();
            int i = this.mStatusConnecting;
            if (j != i) {
              continue;
            }
            bool = true;
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\android\support\v4\media\routing\MediaRouterJellybeanMr1.class

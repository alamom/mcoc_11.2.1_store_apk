    ...
    public static IMediaBrowserServiceCompatCallbacks asInterface(IBinder paramIBinder)
    {
      ...
      for (;;)
      {
        ...
        if ((localIInterface != null) && ((localIInterface instanceof IMediaBrowserServiceCompatCallbacks))) {
          paramIBinder = (IMediaBrowserServiceCompatCallbacks)localIInterface;
        } else {
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\android\support\v4\media\IMediaBrowserServiceCompatCallbacks.class

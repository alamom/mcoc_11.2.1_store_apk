  ...
  public Object getMediaMetadata()
  {
    ...
    for (Object localObject1 = this.mMetadataObj;; localObject1 = this.mMetadataObj)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        Integer localInteger = (Integer)METADATA_KEYS_TYPE.get(localObject1);
        if (localInteger != null) {
          switch (localInteger.intValue())
          {
          default: 
            break;
          case 0: 
            MediaMetadataCompatApi21.Builder.putLong(localObject2, (String)localObject1, getLong((String)localObject1));
            break;
          case 2: 
            MediaMetadataCompatApi21.Builder.putBitmap(localObject2, (String)localObject1, getBitmap((String)localObject1));
            break;
          case 3: 
            MediaMetadataCompatApi21.Builder.putRating(localObject2, (String)localObject1, getRating((String)localObject1).getRating());
            break;
          case 1: 
            MediaMetadataCompatApi21.Builder.putText(localObject2, (String)localObject1, getText((String)localObject1));
          }
        }
      }
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\android\support\v4\media\MediaMetadataCompat.class

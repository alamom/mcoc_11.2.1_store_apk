    ...
    public static IMediaBrowserServiceCompat asInterface(IBinder paramIBinder)
    {
      ...
      for (;;)
      {
        ...
        if ((localIInterface != null) && ((localIInterface instanceof IMediaBrowserServiceCompat))) {
          paramIBinder = (IMediaBrowserServiceCompat)localIInterface;
        } else {
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\android\support\v4\media\IMediaBrowserServiceCompat.class

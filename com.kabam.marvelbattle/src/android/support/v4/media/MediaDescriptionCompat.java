  ...
  implements Parcelable
{
  public static final Parcelable.Creator<MediaDescriptionCompat> CREATOR = new Parcelable.Creator()
  {
    public MediaDescriptionCompat createFromParcel(Parcel paramAnonymousParcel)
    {
      ...
      for (paramAnonymousParcel = new MediaDescriptionCompat(paramAnonymousParcel, null);; paramAnonymousParcel = MediaDescriptionCompat.fromMediaDescription(MediaDescriptionCompatApi21.fromParcel(paramAnonymousParcel))) {
  ...
  public Object getMediaDescription()
  {
    ...
    for (Object localObject = this.mDescriptionObj;; localObject = this.mDescriptionObj)
    {
      return localObject;
      localObject = MediaDescriptionCompatApi21.Builder.newInstance();
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\android\support\v4\media\MediaDescriptionCompat.class

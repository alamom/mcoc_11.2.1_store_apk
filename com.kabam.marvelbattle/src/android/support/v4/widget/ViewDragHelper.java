...
public class ViewDragHelper
{
  ...
  private int computeAxisDuration(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    if (paramInt2 > 0) {}
    for (paramInt1 = Math.round(1000.0F * Math.abs((f2 + f1 * f3) / paramInt2)) * 4;; paramInt1 = (int)((Math.abs(paramInt1) / paramInt3 + 1.0F) * 256.0F))
    {
  ...
  public void abort()
  {
    ...
    if (this.mDragState == 2)
    {
      ...
      this.mCallback.onViewPositionChanged(this.mCapturedView, k, j, k - m, j - i);
    }
    setDragState(0);
  }
  ...
  public boolean continueSettling(boolean paramBoolean)
  {
    if (this.mDragState == 2)
    {
      ...
      int i = j - this.mCapturedView.getLeft();
      int k = m - this.mCapturedView.getTop();
      if (i != 0) {
      ...
      if ((i != 0) || (k != 0)) {
        this.mCallback.onViewPositionChanged(this.mCapturedView, j, m, i, k);
      }
      boolean bool1 = bool2;
      if (bool2)
      {
  ...
  public void processTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      if ((this.mTrackingEdges & j) != 0)
      {
        ...
        {
          tryCaptureViewForDrag(findTopChildUnder((int)f2, (int)f1), j);
          ...
          else
          {
            ...
            for (i = 0;; i++)
            {
              ...
              if (i < j)
              {
                ...
                f1 = f2 - this.mInitialMotionX[k];
                f4 = f3 - this.mInitialMotionY[k];
              ...
              do
              {
                saveLastMotion(paramMotionEvent);
                break;
                localView = findTopChildUnder((int)f2, (int)f3);
              } while ((checkTouchSlop(localView, f1, f4)) && (tryCaptureViewForDrag(localView, k)));
            }
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      for (i = 0;; i++)
      {
        ...
        if (i < k)
        {
          ...
          i1 = localView.getTop();
          int i3 = (int)f2;
          int i5 = this.mCallback.clampViewPositionVertical(localView, i1 + i3, (int)f2);
          int i4 = this.mCallback.getViewHorizontalDragRange(localView);
          i3 = this.mCallback.getViewVerticalDragRange(localView);
          if (((i4 != 0) && ((i4 <= 0) || (i2 != n))) || ((i3 != 0) && ((i3 <= 0) || (i5 != i1)))) {
            break label550;
          }
        }
        label544:
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\android\support\v4\widget\ViewDragHelper.class

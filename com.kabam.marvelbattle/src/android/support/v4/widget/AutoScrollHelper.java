  ...
  implements View.OnTouchListener
{
  ...
  private float computeTargetVelocity(int paramInt, float paramFloat1, float paramFloat2, float paramFloat3)
  {
    ...
    for (;;)
    {
      ...
      if (paramFloat1 > 0.0F) {
        paramFloat1 = constrain(paramFloat1 * paramFloat3, f1, paramFloat2);
      } else {
        paramFloat1 = -constrain(-paramFloat1 * paramFloat3, f1, paramFloat2);
      }
    }
    ...
    private float getValueAt(long paramLong)
    {
      ...
      for (;;)
      {
        ...
        else
        {
          ...
          f1 = AutoScrollHelper.constrain((float)(paramLong - l) / this.mEffectiveRampDown, 0.0F, 1.0F) * f2 + (1.0F - f1);
        }
      }
    }
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\android\support\v4\widget\AutoScrollHelper.class

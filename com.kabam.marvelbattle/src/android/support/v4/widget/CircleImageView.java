  ...
  extends ImageView
{
  ...
  public CircleImageView(Context paramContext, int paramInt, float paramFloat)
  {
    ...
    for (;;)
    {
      ...
      paramContext.getPaint().setShadowLayer(this.mShadowRadius, j, k, 503316480);
    ...
    extends OvalShape
  {
    ...
    public OvalShadow(int paramInt1, int paramInt2)
    {
      ...
      this.mRadialGradient = new RadialGradient(f1, f3, f2, new int[] { 1023410176, 0 }, null, CircleImageView.this);
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\android\support\v4\widget\CircleImageView.class

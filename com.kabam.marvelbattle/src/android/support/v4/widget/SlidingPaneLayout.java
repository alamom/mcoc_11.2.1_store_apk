  ...
  extends ViewGroup
{
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    for (;;)
    {
      localView.layout(j, n, i, n + localView.getMeasuredHeight());
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
      ...
      if (isInEditMode()) {
        if (m == Integer.MIN_VALUE)
        {
          ...
          default: 
            ...
            {
              ((LayoutParams)localObject1).dimWhenOffset = false;
              i2 = m;
              j = i;
              bool2 = bool1;
            }
    ...
    do
    {
      ...
      f2 = f1 + ((LayoutParams)localObject1).weight;
      bool2 = bool1;
      j = i;
      f1 = f2;
      i2 = m;
    } while (((LayoutParams)localObject1).width == 0);
    label393:
    paramInt1 = ((LayoutParams)localObject1).leftMargin + ((LayoutParams)localObject1).rightMargin;
    ...
    {
      ((LayoutParams)localObject1).slideable = bool2;
      bool1 |= bool2;
      bool2 = bool1;
      j = paramInt1;
      f1 = f2;
      i2 = i;
      if (!((LayoutParams)localObject1).slideable) {
        break;
      }
      this.mSlideableView = ((View)localObject2);
      bool2 = bool1;
      j = paramInt1;
      f1 = f2;
      i2 = i;
      ...
      paramInt1 = View.MeasureSpec.makeMeasureSpec(((LayoutParams)localObject1).width, 1073741824);
      break label426;
      ...
      j = View.MeasureSpec.makeMeasureSpec(((LayoutParams)localObject1).height, 1073741824);
      break label445;
    }
    label650:
    if ((bool1) || (f1 > 0.0F))
    {
      ...
      if (j < i4)
      {
        ...
        for (;;)
        {
          ...
          if (((View)localObject1).getVisibility() != 8)
          {
            if ((((LayoutParams)localObject2).width == 0) && (((LayoutParams)localObject2).weight > 0.0F))
            {
              paramInt1 = 1;
              label744:
              if (paramInt1 == 0) {
              ...
              n = 0;
              label751:
              if ((!bool1) || (localObject1 == this.mSlideableView)) {
                break label894;
              }
              if ((((LayoutParams)localObject2).width >= 0) || ((n <= i1) && (((LayoutParams)localObject2).weight <= 0.0F))) {
                continue;
              }
              if (paramInt1 == 0) {
                break label879;
            ...
            for (;;)
            {
              ((View)localObject1).measure(View.MeasureSpec.makeMeasureSpec(i1, 1073741824), paramInt1);
              break;
              paramInt1 = 0;
              break label744;
              label834:
              ...
              {
                paramInt1 = View.MeasureSpec.makeMeasureSpec(((LayoutParams)localObject2).height, 1073741824);
                continue;
                label879:
                paramInt1 = View.MeasureSpec.makeMeasureSpec(((View)localObject1).getMeasuredHeight(), 1073741824);
              }
            }
            label894:
            if (((LayoutParams)localObject2).weight > 0.0F)
            {
              ...
              for (;;)
              {
                ...
                i2 = i3 - (((LayoutParams)localObject2).leftMargin + ((LayoutParams)localObject2).rightMargin);
                int i5 = View.MeasureSpec.makeMeasureSpec(i2, 1073741824);
                if (n == i2) {
                  break;
                }
                ((View)localObject1).measure(i5, paramInt1);
                break;
                if (((LayoutParams)localObject2).height == -1)
                {
                  paramInt1 = View.MeasureSpec.makeMeasureSpec(paramInt2, 1073741824);
              ...
              label1029:
              i2 = Math.max(0, m);
              ((View)localObject1).measure(View.MeasureSpec.makeMeasureSpec(n + (int)(((LayoutParams)localObject2).weight * i2 / f1), 1073741824), paramInt1);
            }
          }
        }
      }
    ...
    for (;;)
    {
      ...
      case 1: 
        ...
        if (isDimmed(this.mSlideableView))
        {
          ...
          {
            bool1 = bool2;
            if (this.mDragHelper.isViewUnder(this.mSlideableView, (int)f4, (int)f1))
            {
  ...
  boolean smoothSlideTo(float paramFloat, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      for (paramInt = (int)(getWidth() - (paramInt + j + this.mSlideRange * paramFloat + i));; paramInt = (int)(getPaddingLeft() + localLayoutParams.leftMargin + this.mSlideRange * paramFloat))
      {
  ...
  void updateObscuredViewsVisibility(View paramView)
  {
    ...
    if (bool)
    {
      ...
      int i9 = Math.max(i6, localView.getTop());
      if (!bool) {
        break label268;
      }
      i3 = i;
      ...
      i3 = Math.min(i4 - i5, localView.getBottom());
      if ((i8 < m) || (i9 < i1) || (i10 > n) || (i3 > k)) {
        break label274;
      }
    }
    label268:
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\android\support\v4\widget\SlidingPaneLayout.class

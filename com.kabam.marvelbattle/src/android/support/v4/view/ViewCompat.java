...
public class ViewCompat
{
    ...
    implements ViewCompat.ViewCompatImpl
  {
    ...
    public boolean dispatchNestedFling(View paramView, float paramFloat1, float paramFloat2, boolean paramBoolean)
    {
      ...
      for (paramBoolean = ((NestedScrollingChild)paramView).dispatchNestedFling(paramFloat1, paramFloat2, paramBoolean);; paramBoolean = false) {
        return paramBoolean;
      }
    }
    ...
    extends ViewCompat.HCViewCompatImpl
  {
    ...
    public boolean hasAccessibilityDelegate(View paramView)
    {
      ...
      //   10: iload_2
      //   11: ireturn
      //   12: getstatic 56	android/support/v4/view/ViewCompat$ICSViewCompatImpl:mAccessibilityDelegateField	Ljava/lang/reflect/Field;
      //   15: ifnonnull +20 -> 35
      //   18: ldc 58
      //   20: ldc 60
      //   22: invokevirtual 66	java/lang/Class:getDeclaredField	(Ljava/lang/String;)Ljava/lang/reflect/Field;
      //   25: putstatic 56	android/support/v4/view/ViewCompat$ICSViewCompatImpl:mAccessibilityDelegateField	Ljava/lang/reflect/Field;
      //   28: getstatic 56	android/support/v4/view/ViewCompat$ICSViewCompatImpl:mAccessibilityDelegateField	Ljava/lang/reflect/Field;
      //   31: iconst_1
      //   32: invokevirtual 72	java/lang/reflect/Field:setAccessible	(Z)V
      //   35: getstatic 56	android/support/v4/view/ViewCompat$ICSViewCompatImpl:mAccessibilityDelegateField	Ljava/lang/reflect/Field;
      //   38: aload_1
      //   39: invokevirtual 73	java/lang/reflect/Field:get	(Ljava/lang/Object;)Ljava/lang/Object;
      //   42: astore_1
      //   43: aload_1
      //   44: ifnull +16 -> 60
      //   47: iload_3
      ...
      //   52: astore_1
      //   53: iconst_1
      //   54: putstatic 15	android/support/v4/view/ViewCompat$ICSViewCompatImpl:accessibilityDelegateCheckFailed	Z
      //   57: goto -47 -> 10
      //   60: iconst_0
      //   61: istore_2
      //   62: goto -13 -> 49
      //   65: astore_1
      //   66: iconst_1
      //   67: putstatic 15	android/support/v4/view/ViewCompat$ICSViewCompatImpl:accessibilityDelegateCheckFailed	Z
      //   70: goto -60 -> 10
      // Local variable table:
      //   start	length	slot	name	signature
      //   0	73	0	this	ICSViewCompatImpl
      //   0	73	1	paramView	View
      //   3	59	2	bool1	boolean
      //   1	47	3	bool2	boolean
      // Exception table:
      //   from	to	target	type
      //   18	35	52	java/lang/Throwable
      //   35	43	65	java/lang/Throwable
    }
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\android\support\v4\view\ViewCompat.class

  ...
  extends PagerTitleStrip
{
  ...
  protected void onDraw(Canvas paramCanvas)
  {
    ...
    paramCanvas.drawRect(m - i1, j - i, k + n, j, this.mTabPaint);
  ...
  void updateTextPositions(int paramInt, float paramFloat, boolean paramBoolean)
  {
    ...
    int j = m - this.mIndicatorHeight;
    localRect.set(i1 - k, j, n + i, m);
    super.updateTextPositions(paramInt, paramFloat, paramBoolean);
    this.mTabAlpha = ((int)(Math.abs(paramFloat - 0.5F) * 2.0F * 255.0F));
    localRect.union(this.mCurrText.getLeft() - this.mTabPadding, j, this.mCurrText.getRight() + this.mTabPadding, m);
    invalidate(localRect);
  }
}


/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\android\support\v4\view\PagerTabStrip.class

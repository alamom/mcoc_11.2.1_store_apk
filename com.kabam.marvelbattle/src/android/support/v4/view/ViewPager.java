  ...
  extends ViewGroup
{
    ...
    if ((Math.abs(paramInt3) > this.mFlingDistance) && (Math.abs(paramInt2) > this.mMinimumVelocity))
    {
      ...
      for (;;)
      {
        ...
        if (this.mItems.size() > 0)
        {
          ...
          paramInt2 = Math.max(localItemInfo2.position, Math.min(paramInt1, localItemInfo1.position));
        }
        return paramInt2;
        paramInt1++;
      }
  ...
  private void recomputeScrollPosition(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    if ((paramInt2 > 0) && (!this.mItems.isEmpty()))
    {
      ...
      paramInt4 = (int)((paramInt1 - m - i + paramInt3) * f);
  ...
  protected boolean canScroll(View paramView, boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    if ((paramView instanceof ViewGroup))
    {
      ...
      if (i >= 0)
      {
        ...
        if ((paramInt2 + k >= localView.getLeft()) && (paramInt2 + k < localView.getRight()) && (paramInt3 + j >= localView.getTop()) && (paramInt3 + j < localView.getBottom()) && (canScroll(localView, true, paramInt1, paramInt2 + k - localView.getLeft(), paramInt3 + j - localView.getTop()))) {
          paramBoolean = true;
        }
      }
    }
  ...
  public void draw(Canvas paramCanvas)
  {
    ...
    if ((m == 0) || ((m == 1) && (this.mAdapter != null) && (this.mAdapter.getCount() > 1)))
    {
      ...
      if (!this.mRightEdge.isFinished())
      {
        ...
        this.mRightEdge.setSize(k - i2 - n, i1);
  ...
  public void endFakeDrag()
  {
    ...
    setCurrentItemInternal(determineTargetPage(((ItemInfo)localObject).position, (j / i - ((ItemInfo)localObject).offset) / ((ItemInfo)localObject).widthFactor, k, (int)(this.mLastMotionX - this.mInitialMotionX)), true, true, k);
    endDrag();
  ...
  public void fakeDragBy(float paramFloat)
  {
    ...
    if (((ItemInfo)localObject).position != this.mAdapter.getCount() - 1) {
      f1 = ((ItemInfo)localObject).offset * i;
    }
    if (f2 < paramFloat) {}
    for (;;)
    {
  ...
  protected void onDraw(Canvas paramCanvas)
  {
    ...
    if ((this.mPageMargin > 0) && (this.mMarginDrawable != null) && (this.mItems.size() > 0) && (this.mAdapter != null))
    {
      ...
      k = ((ItemInfo)this.mItems.get(m - 1)).position;
    }
    for (;;)
    {
      float f2;
      if (i < k)
      {
        ...
        f2 = (((ItemInfo)localObject).offset + ((ItemInfo)localObject).widthFactor) * n;
      }
      label268:
      float f4;
      for (f1 = ((ItemInfo)localObject).offset + ((ItemInfo)localObject).widthFactor + f3;; f1 += f4 + f3)
      {
        if (this.mPageMargin + f2 > i1)
        {
    ...
    if (m < i3)
    {
      ...
      if (((View)localObject1).getVisibility() != 8)
      {
        ...
        if (((LayoutParams)localObject2).isDecor)
        {
          ...
          n = ((LayoutParams)localObject2).gravity;
      ...
      for (;;)
      {
        ...
        break;
        paramInt3 = paramInt2;
        i = paramInt2 + ((View)localObject1).getMeasuredWidth();
        break label190;
        paramInt3 = Math.max((i5 - ((View)localObject1).getMeasuredWidth()) / 2, paramInt2);
        i = paramInt2;
        break label190;
        paramInt3 = i5 - j - ((View)localObject1).getMeasuredWidth();
        ...
        continue;
        paramInt2 = Math.max((i4 - ((View)localObject1).getMeasuredHeight()) / 2, paramInt1);
        continue;
        paramInt2 = i4 - paramInt4 - ((View)localObject1).getMeasuredHeight();
    ...
    for (paramInt3 = 0; paramInt3 < i3; paramInt3++)
    {
      ...
      if (((View)localObject2).getVisibility() != 8)
      {
        ...
        if (!localLayoutParams.isDecor)
        {
          ...
          {
            j = paramInt2 + (int)(i * ((ItemInfo)localObject1).offset);
            if (localLayoutParams.needsMeasure)
            {
              localLayoutParams.needsMeasure = false;
              ((View)localObject2).measure(View.MeasureSpec.makeMeasureSpec((int)(i * localLayoutParams.widthFactor), 1073741824), View.MeasureSpec.makeMeasureSpec(i4 - paramInt1 - paramInt4, 1073741824));
            }
            ((View)localObject2).layout(j, paramInt1, ((View)localObject2).getMeasuredWidth() + j, ((View)localObject2).getMeasuredHeight() + paramInt1);
          }
        }
      }
    }
      ...
      if (localView.getVisibility() != 8)
      {
        ...
        if (localLayoutParams != null)
        {
          ...
          if (localLayoutParams.isDecor)
          {
            ...
            localView.measure(View.MeasureSpec.makeMeasureSpec(i2, j), View.MeasureSpec.makeMeasureSpec(i, i3));
            if (m == 0) {
              break label381;
            }
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      if (this.mIsBeingDragged)
      {
        ...
        int k = getScrollX();
        localObject = infoForCurrentScrollPosition();
        setCurrentItemInternal(determineTargetPage(((ItemInfo)localObject).position, (k / i - ((ItemInfo)localObject).offset) / ((ItemInfo)localObject).widthFactor, j, (int)(MotionEventCompat.getX(paramMotionEvent, MotionEventCompat.findPointerIndex(paramMotionEvent, this.mActivePointerId)) - this.mInitialMotionX)), true, true, j);
        bool1 = resetTouch();
        continue;
        bool1 = bool2;
        if (this.mIsBeingDragged)
        ...
        if (hasFocus())
        {
          ...
          for (localObject1 = infoForAnyChild((View)localObject1);; localObject1 = null)
          {
            ...
            for (paramInt = 0;; paramInt++)
            {
              ...
              localObject2 = getChildAt(paramInt);
              localObject1 = infoForChild((View)localObject2);
              if ((localObject1 != null) && (((ItemInfo)localObject1).position == this.mCurItem) && (((View)localObject2).requestFocus(j))) {
                break;
              }
            }
            break;
  ...
  void smoothScrollTo(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    if (paramInt3 > 0) {}
    for (paramInt1 = Math.round(1000.0F * Math.abs((f1 + f2 * f3) / paramInt3)) * 4;; paramInt1 = (int)((1.0F + Math.abs(k) / (this.mPageMargin + f2 * f1)) * 100.0F))
    {
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\android\support\v4\view\ViewPager.class

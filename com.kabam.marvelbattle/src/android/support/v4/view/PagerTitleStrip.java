  ...
  implements ViewPager.Decor
{
  ...
  void updateTextPositions(int paramInt, float paramFloat, boolean paramBoolean)
  {
    ...
    if (paramInt != this.mLastKnownCurrentPage)
    {
      ...
      i = this.mCurrText.getMeasuredWidth();
      ...
      i4 = i1 - i4 - (int)((i1 - (i2 + i3) - i4) * f1) - i / 2;
      i3 = i4 + i;
      i7 = this.mPrevText.getBaseline();
      i = this.mCurrText.getBaseline();
      i5 = this.mNextText.getBaseline();
      i8 = Math.max(Math.max(i7, i), i5);
      i7 = i8 - i7;
      i = i8 - i;
      i5 = i8 - i5;
      ...
      i8 = Math.max(Math.max(i7 + i9, i + i8), i5 + i10);
    ...
    for (;;)
    {
      ...
      i = Math.min(i2, i4 - this.mScaledTextSpacing - n);
      this.mPrevText.layout(i, j, i + n, this.mPrevText.getMeasuredHeight() + j);
      i = Math.max(i1 - m - k, this.mScaledTextSpacing + i3);
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\android\support\v4\view\PagerTitleStrip.class

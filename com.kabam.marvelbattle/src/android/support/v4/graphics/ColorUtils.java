...
public class ColorUtils
{
  ...
  {
    float f3 = paramInt1 / 255.0F;
    float f7 = paramInt2 / 255.0F;
    float f1 = paramInt3 / 255.0F;
    float f5 = Math.max(f3, Math.max(f7, f1));
    float f6 = Math.min(f3, Math.min(f7, f1));
    float f2 = f5 - f6;
    float f4 = (f5 + f6) / 2.0F;
    if (f5 == f6)
    {
...
/* Location:              C:\tools\androidhack\com.kabam.marvelbattle\classes.jar!\android\support\v4\graphics\ColorUtils.class
